...
NDS_INACTIVE_STATUS_STUB(ftCommonAttackLw3ProcUpdate)
NDS_INACTIVE_STATUS_STUB(ftCommonAttackLw3ProcInterrupt)
NDS_INACTIVE_STATUS_STUB(ftCommonAttackS4ProcUpdate)
NDS_INACTIVE_STATUS_STUB(ftCommonAppearProcUpdate)
NDS_INACTIVE_STATUS_STUB(ftCommonAppearProcPhysics)
NDS_INACTIVE_STATUS_STUB(ftMarioSpecialNProcUpdate)
NDS_INACTIVE_STATUS_STUB(ftMarioSpecialNProcMap)
NDS_INACTIVE_STATUS_STUB(ftMarioSpecialAirNProcMap)
...
NDS_INACTIVE_STATUS_STUB(ftFoxSpecialNProcUpdate)
NDS_INACTIVE_STATUS_STUB(ftFoxSpecialNProcInterrupt)
