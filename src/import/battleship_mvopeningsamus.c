...
#define mvOpeningSamusFuncRun ndsBaseMVOpeningSamusFuncRun
#define mvOpeningSamusFuncStart ndsBaseMVOpeningSamusFuncStart
#define mvOpeningSamusStartScene ndsBaseMVOpeningSamusStartScene

#include "../../decomp/BattleShip-main/decomp/src/mv/mvopening/mvopeningsamus.c"

#undef mvOpeningSamusFuncRun
#undef mvOpeningSamusFuncStart
#undef mvOpeningSamusStartScene

NDS_OPENING_NAME_SCENE_IMPL(Samus, nSCKindOpeningSamus, 1785u,
                            nSCKindOpeningYoshi)
