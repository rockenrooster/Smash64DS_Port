...
#define mvOpeningPikachuFuncRun ndsBaseMVOpeningPikachuFuncRun
#define mvOpeningPikachuFuncStart ndsBaseMVOpeningPikachuFuncStart
#define mvOpeningPikachuStartScene ndsBaseMVOpeningPikachuStartScene

#include "../../decomp/BattleShip-main/decomp/src/mv/mvopening/mvopeningpikachu.c"

#undef mvOpeningPikachuFuncRun
#undef mvOpeningPikachuFuncStart
#undef mvOpeningPikachuStartScene

NDS_OPENING_NAME_SCENE_IMPL(Pikachu, nSCKindOpeningPikachu, 2145u,
                            nSCKindOpeningRun)
