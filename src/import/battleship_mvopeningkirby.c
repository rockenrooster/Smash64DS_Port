...
#define mvOpeningKirbyFuncRun ndsBaseMVOpeningKirbyFuncRun
#define mvOpeningKirbyFuncStart ndsBaseMVOpeningKirbyFuncStart
#define mvOpeningKirbyStartScene ndsBaseMVOpeningKirbyStartScene

#include "../../decomp/BattleShip-main/decomp/src/mv/mvopening/mvopeningkirby.c"

#undef mvOpeningKirbyFuncRun
#undef mvOpeningKirbyFuncStart
#undef mvOpeningKirbyStartScene

NDS_OPENING_NAME_SCENE_IMPL(Kirby, nSCKindOpeningKirby, 1965u,
                            nSCKindOpeningFox)
