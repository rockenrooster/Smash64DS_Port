...
#define mvOpeningYoshiFuncRun ndsBaseMVOpeningYoshiFuncRun
#define mvOpeningYoshiFuncStart ndsBaseMVOpeningYoshiFuncStart
#define mvOpeningYoshiStartScene ndsBaseMVOpeningYoshiStartScene

#include "../../decomp/BattleShip-main/decomp/src/mv/mvopening/mvopeningyoshi.c"

#undef mvOpeningYoshiFuncRun
#undef mvOpeningYoshiFuncStart
#undef mvOpeningYoshiStartScene

NDS_OPENING_NAME_SCENE_IMPL(Yoshi, nSCKindOpeningYoshi, 1875u,
                            nSCKindOpeningKirby)
