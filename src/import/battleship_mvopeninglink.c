...
#define mvOpeningLinkFuncRun ndsBaseMVOpeningLinkFuncRun
#define mvOpeningLinkFuncStart ndsBaseMVOpeningLinkFuncStart
#define mvOpeningLinkStartScene ndsBaseMVOpeningLinkStartScene

#include "../../decomp/BattleShip-main/decomp/src/mv/mvopening/mvopeninglink.c"

#undef mvOpeningLinkFuncRun
#undef mvOpeningLinkFuncStart
#undef mvOpeningLinkStartScene

NDS_OPENING_NAME_SCENE_IMPL(Link, nSCKindOpeningLink, 1695u,
                            nSCKindOpeningSamus)
