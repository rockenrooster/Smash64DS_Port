...
static s32 ndsAudioFgmIDIsIncluded(u16 id)
{
    ...
    case nSYAudioFGMNessFoot:
    case nSYAudioFGMNessDash:
    case nSYAudioFGMNessPKThunderLoop:
    case nSYAudioFGMNessPSI:
    case nSYAudioFGMNessPSIAgain:
    case nSYAudioFGMNessSpecialLwStart:
    case nSYAudioFGMNessDeadSlam:
    case nSYAudioFGMNessDownBounce:
    case nSYAudioVoiceNessAppeal:
    case nSYAudioVoiceNessSmash1:
    case nSYAudioVoiceNessSmash2:
    case nSYAudioVoiceNessSmash3:
    case nSYAudioVoiceNessUnkGrunt:
    case nSYAudioVoiceNessDeadUp:
    case nSYAudioVoiceNessFuraFura:
    case nSYAudioVoiceNessDamage:
    case nSYAudioVoiceNessUnkPing:
    case nSYAudioVoiceNessHeavyGet:
    case nSYAudioVoiceNessOttotto:
    case nSYAudioVoiceNessSpecialN:
    case nSYAudioVoiceNessFinalPK:
    case nSYAudioVoiceNessFinalStarstorm:
    case nSYAudioVoiceNessSpecialHi:
    case nSYAudioVoiceNessDead:
    case nSYAudioVoiceNessFuraSleep:
    case nSYAudioVoiceAnnounceNess:
    case nSYAudioVoicePublicNess:
    /* P2-3 Purin's bank (admit_fighter.py). */
    case nSYAudioFGMPurinLanding:
    case nSYAudioFGMPurinFoot:
    case nSYAudioFGMPurinDash:
    case nSYAudioFGMPurinDeadSlam:
    case nSYAudioFGMPurinDownBounce:
    case nSYAudioVoiceAnnouncePurin:
    case nSYAudioVoicePurinAppeal:
    case nSYAudioVoicePurinSmash1:
    case nSYAudioVoicePurinSmash2:
    case nSYAudioVoicePurinSmash3:
    case nSYAudioVoicePurinSpecialN:
    case nSYAudioVoicePurinDeadUp:
    case nSYAudioVoicePurinFuraFura:
    case nSYAudioVoicePurinDamage:
    case nSYAudioVoicePurinUnkGrunt1:
    case nSYAudioVoicePurinUnkGrunt2:
    case nSYAudioVoicePurinUnkGrunt3:
    case nSYAudioVoicePurinUnkGrunt4:
    case nSYAudioVoicePurinFuraSleep:
    case nSYAudioVoicePurinSpecialLwSleep:
    case nSYAudioVoicePurinSpecialLwWake:
    case nSYAudioVoicePurinSpecialHi:
    case nSYAudioVoicePublicPurin:
    /* P2-3 Kirby's bank (admit_fighter.py). */
    case nSYAudioFGMKirbyLanding:
    case nSYAudioFGMKirbyPurinJump:
    case nSYAudioFGMKirbyFoot:
    case nSYAudioFGMKirbyDash:
    case nSYAudioFGMKirbySpecialLwLanding:
    case nSYAudioFGMKirbyAttackAirHi:
    case nSYAudioFGMKirbySpecialNThrow:
    case nSYAudioFGMKirbySpecialNCopyEat:
    case nSYAudioFGMKirbySpecialNCopyThrow:
    case nSYAudioFGMKirbySpecialNCopyUnk:
    case nSYAudioFGMKirbyStarPing1:
    case nSYAudioFGMKirbyStarPing2:
    case nSYAudioFGMKirbySpecialLwStart:
    case nSYAudioFGMKirbySpecialNStart:
    case nSYAudioFGMKirbySpecialNLoseCopy:
    case nSYAudioFGMKirbyDeadSlam:
    case nSYAudioFGMKirbyDownBounce:
    case nSYAudioVoiceKirbyAppeal:
    case nSYAudioVoiceKirbySmash1:
    case nSYAudioVoiceKirbySmash2:
    case nSYAudioVoiceKirbySmash3:
    case nSYAudioVoiceKirbyCopyLinkSpecialN:
    case nSYAudioVoiceKirbyCopyPikachuSpecialN:
    case nSYAudioVoiceKirbySpecialHi:
    case nSYAudioVoiceKirbyCopyCaptainSpecialNFalcon:
    case nSYAudioVoiceKirbyCopyCaptainSpecialNPunch:
    case nSYAudioVoiceKirbyCopyDonkeySpecialN:
    case nSYAudioVoiceKirbyCopyPurinSpecialN:
    case nSYAudioVoiceKirbyDeadUp:
    case nSYAudioVoiceKirbyFuraFura:
    case nSYAudioVoiceKirbyDamage:
    case nSYAudioVoiceKirbyUnkGrunt1:
    case nSYAudioVoiceKirbyUnkGrunt2:
    case nSYAudioVoiceKirbyHeavyGet:
    case nSYAudioVoiceKirbyOttotto:
    case nSYAudioVoiceKirbyCopyNessSpecialN:
    case nSYAudioVoiceKirbyDead:
    case nSYAudioVoiceKirbyFuraSleep:
    case nSYAudioVoiceKirbySpecialLw:
    case nSYAudioVoiceKirbyUnkPing:
    case nSYAudioVoiceAnnounceKirby:
    case nSYAudioVoicePublicKirby:
    case nSYAudioFGMExplodeL:
    case nSYAudioFGMSamusJump1:
    case nSYAudioFGMStarGet:
    case nSYAudioFGMInflateJump1:
    case nSYAudioFGMInflateJump5:
    case nSYAudioFGMUnkMechanical4:
    case nSYAudioFGMUnkLongWind:
    case nSYAudioFGMLinkSpecialNGet:
    case nSYAudioFGMCharacterUnkZip4:
    case nSYAudioFGMInflateJump3:
    case nSYAudioFGMInflateJump8:
    case nSYAudioFGMCharacterUnk2:
    case nSYAudioFGMCharacterUnk3:
    case nSYAudioFGMCharacterUnkZip9:
    case nSYAudioFGMBurnL:
    case nSYAudioFGMBurnM:
    case nSYAudioFGMItemThrow:
    case nSYAudioFGMLinkSpecialNShoot:
    case nSYAudioFGMCharacterUnk1:
    case nSYAudioVoicePublicAbsorb:
    case nSYAudioFGMCharacterUnkZip7:
