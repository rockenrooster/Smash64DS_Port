 ...
 * loaded file. Only the OWNED subset -- the registry's other ITCommonData row,
 * the Star Rod weapon attributes Kirby's star reads, is defined by
 * src/import/battleship_item_starrod.c. */
#define NDS_DEFINE_IT_COMMON_DATA_RELOC_SYMBOL(asset, name, value) \
    uintptr_t name = value;
NDS_IT_COMMON_DATA_OWNED_RELOC_SYMBOLS(NDS_DEFINE_IT_COMMON_DATA_RELOC_SYMBOL)
...
#undef NDS_DEFINE_MN_SCREEN_ADJUST_RELOC_SYMBOL

#define NDS_DEFINE_MN_COMMON_EXTRA_RELOC_SYMBOL(asset, name, value) uintptr_t name = value;
NDS_MN_COMMON_EXTRA_RELOC_SYMBOLS(NDS_DEFINE_MN_COMMON_EXTRA_RELOC_SYMBOL)
#undef NDS_DEFINE_MN_COMMON_EXTRA_RELOC_SYMBOL

#define NDS_DEFINE_MN_PLAYERS_GAME_MODES_EXTRA_RELOC_SYMBOL(asset, name, value) uintptr_t name = value;
NDS_MN_PLAYERS_GAME_MODES_EXTRA_RELOC_SYMBOLS(NDS_DEFINE_MN_PLAYERS_GAME_MODES_EXTRA_RELOC_SYMBOL)
#undef NDS_DEFINE_MN_PLAYERS_GAME_MODES_EXTRA_RELOC_SYMBOL

uintptr_t llBonus2CommonFileID = 0x88u;
#define NDS_DEFINE_BONUS2_COMMON_RELOC_SYMBOL(asset, name, value) uintptr_t name = value;
NDS_BONUS2_COMMON_RELOC_SYMBOLS(NDS_DEFINE_BONUS2_COMMON_RELOC_SYMBOL)
#undef NDS_DEFINE_BONUS2_COMMON_RELOC_SYMBOL
