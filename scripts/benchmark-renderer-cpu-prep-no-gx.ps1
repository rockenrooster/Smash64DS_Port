...
& (Join-Path $PSScriptRoot 'verify-battle-mariofox-gcrunall-loop-harness.ps1') `
    ...
    -Target 'smash64ds-battle-playable-coarse-cpu-prep-no-gx-hwtri' `
    -Build 'build-battle-playable-coarse-cpu-prep-no-gx-hwtri-harness' `
    -ExpectedMode 163 `
    -ExpectedHarnessSceneCurr 22 `
    -ExpectedHarnessScenePrev 21 `
    -Label 'battle_playable CPU_PREP_NO_GX floor' `
    -HarnessSelectMessage 'CPU_PREP_NO_GX benchmark did not select Pupupu VSBattle from Maps.'
