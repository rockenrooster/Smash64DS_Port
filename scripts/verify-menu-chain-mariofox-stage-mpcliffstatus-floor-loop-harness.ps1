...
$target = if ($HardwareTriangles) { 'smash64ds-menu-chain-mariofox-stage-mpcliffstatus-floor-loop-hwtri' } else { 'smash64ds-menu-chain-mariofox-stage-mpcliffstatus-floor-loop' }
$build = if ($HardwareTriangles) { 'build-menu-chain-mariofox-stage-mpcliffstatus-floor-loop-hwtri-harness' } else { 'build-menu-chain-mariofox-stage-mpcliffstatus-floor-loop-harness' }
