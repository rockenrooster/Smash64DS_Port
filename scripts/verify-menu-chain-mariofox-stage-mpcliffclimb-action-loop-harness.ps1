...
& (Join-Path $PSScriptRoot 'verify-battle-mariofox-gcdrawall-loop-harness.ps1') `
    ...
    -Label 'Menu-chain Mario/Fox Stage MP Cliff-climb action-loop' `
    -HarnessSelectMessage 'Menu-chain Mario/Fox Stage MP Cliff-climb action-loop harness did not select VS Mode from Title.' `
    -RequireStageDraw `
