...
try {
    ...
    if (-not $p0.Success -or [int]$p0.Groups[1].Value -ne 0 -or [int]$p0.Groups[2].Value -ne 0 -or [int]$p0.Groups[3].Value -ne 55 -or [int]$p0.Groups[4].Value -ne 0 -or [int]$p0.Groups[5].Value -ne 0 -or [int]$p0.Groups[6].Value -ne 0 -or [int]$p0.Groups[7].Value -ne 0 -or (Convert-MarkerUInt32 $p0.Groups[8].Value) -ne [uint32]::MaxValue) {
        throw "Mario init-state fields failed after menu chain.`n$gdbStdout"
    }
    if (-not $p1.Success -or [int]$p1.Groups[1].Value -ne 1 -or [int]$p1.Groups[2].Value -ne 0 -or [int]$p1.Groups[3].Value -ne 55 -or [int]$p1.Groups[4].Value -ne 0 -or [int]$p1.Groups[5].Value -ne 0 -or [int]$p1.Groups[6].Value -ne 0 -or [int]$p1.Groups[7].Value -ne 0 -or (Convert-MarkerUInt32 $p1.Groups[8].Value) -ne [uint32]::MaxValue) {
