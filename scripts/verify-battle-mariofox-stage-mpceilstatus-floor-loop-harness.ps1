...
$target = if ($HardwareTriangles) { 'smash64ds-battle-mariofox-stage-mpceilstatus-floor-loop-hwtri' } else { 'smash64ds-battle-mariofox-stage-mpceilstatus-floor-loop' }
$build = if ($HardwareTriangles) { 'build-battle-mariofox-stage-mpceilstatus-floor-loop-hwtri-harness' } else { 'build-battle-mariofox-stage-mpceilstatus-floor-loop-harness' }
