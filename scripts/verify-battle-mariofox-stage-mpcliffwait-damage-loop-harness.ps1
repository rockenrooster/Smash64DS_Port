...
& (Join-Path $PSScriptRoot 'verify-battle-mariofox-gcdrawall-loop-harness.ps1') `
    ...
    -Label 'Battle Mario/Fox Stage MP Cliff-wait damage-loop' `
    -HarnessSelectMessage 'Direct Mario/Fox Stage MP Cliff-wait damage-loop harness did not select VSBattle from Maps.' `
    -RequireStageDraw `
