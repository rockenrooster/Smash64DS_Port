...
$target = if ($HardwareTriangles) { 'smash64ds-battle-mariofox-stage-floor-follow-loop-hwtri' } else { 'smash64ds-battle-mariofox-stage-floor-follow-loop' }
$build = if ($HardwareTriangles) { 'build-battle-mariofox-stage-floor-follow-loop-hwtri-harness' } else { 'build-battle-mariofox-stage-floor-follow-loop-harness' }
