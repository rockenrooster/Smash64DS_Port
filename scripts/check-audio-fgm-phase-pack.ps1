...
if (([int]$metadata.format_version -ne 4) -or
    ...
    ([int64]$metadata.resident_bytes -ne 2725028) -or
    ...
    #    IMA floor).
    ($metadata.mapping_sha256_lo -ne '0xe90df2ec') -or
    ...
    ($metadata.pack_sha256 -ne
        '1d542b21be2b01a1a22dcbe2c81a8a8b49886b5c68a046d714bd8ba0cb458234')) {
