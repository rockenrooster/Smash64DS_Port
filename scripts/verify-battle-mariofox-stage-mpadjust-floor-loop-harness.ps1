...
$target = if ($HardwareTriangles) { 'smash64ds-battle-mariofox-stage-mpadjust-floor-loop-hwtri' } else { 'smash64ds-battle-mariofox-stage-mpadjust-floor-loop' }
$build = if ($HardwareTriangles) { 'build-battle-mariofox-stage-mpadjust-floor-loop-hwtri-harness' } else { 'build-battle-mariofox-stage-mpadjust-floor-loop-harness' }
