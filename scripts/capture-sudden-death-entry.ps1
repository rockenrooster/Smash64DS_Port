...
try {
    ...
    $gdbLines = @(
        ...
        'x/24wx gGRCommonStruct.pupupu.map_gobj[0]',
        'x/24wx gGRCommonStruct.pupupu.map_gobj[1]',
        'x/24wx gGRCommonStruct.pupupu.map_gobj[2]',
        'x/24wx gGRCommonStruct.pupupu.map_gobj[3]',
        'x/24wx gGRCommonLayerGObjs[1]',
