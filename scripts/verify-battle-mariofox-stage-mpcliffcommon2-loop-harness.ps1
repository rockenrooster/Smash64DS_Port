...
$target = if ($HardwareTriangles) { 'smash64ds-battle-mariofox-stage-mpcliffcommon2-loop-hwtri' } else { 'smash64ds-battle-mariofox-stage-mpcliffcommon2-loop' }
$build = if ($HardwareTriangles) { 'build-battle-mariofox-stage-mpcliffcommon2-loop-hwtri-harness' } else { 'build-battle-mariofox-stage-mpcliffcommon2-loop-harness' }
