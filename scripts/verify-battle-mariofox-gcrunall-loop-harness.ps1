    ...
    if ($BattlePlayable -and $RealtimePresentation -and $HardwareTriangles -and -not $MatchLifecycleProof) {
        if ($RendererBenchmarkSamples -gt 0) {
            ...
            if ($RendererProfileLevel -ge 1) {
                ...
                $coarseBenchmarkCommands += 'printf "PUPUPU_AOT_BENCH=%u,%u,%#x,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u\n", gNdsRendererProfileFrameCount, gNdsRendererPupupuWaterAotMode, gNdsRendererPupupuWaterAotInitResult, gNdsRendererPupupuWaterAotCandidateCount, gNdsRendererPupupuWaterAotLookupHitCount, gNdsRendererPupupuWaterAotLookupMissCount, gNdsRendererPupupuWaterAotSourceRejectCount, gNdsRendererPupupuWaterAotReadCount, gNdsRendererPupupuWaterAotReadFailCount, gNdsRendererPupupuWaterAotReadBytes, gNdsRendererPupupuWaterAotReadTicks, gNdsRendererPupupuWaterAotComparePassCount, gNdsRendererPupupuWaterAotCompareFailCount, gNdsRendererPupupuWaterAotDirectCount, gNdsRendererPupupuWaterAotFallbackCount, gNdsRendererPupupuWaterAotPreparedCacheHitCount, gNdsRendererPupupuWaterAotPreparedCacheMissCount, gNdsRendererPupupuWaterAotPreparedCacheReplacementCount, gNdsRendererPupupuWaterAotPreparedCacheInvalidationCount, gNdsRendererPupupuWaterAotPreparedCacheStaleRejectCount, gNdsRendererPupupuWaterAotLiveConvertCount, gNdsRendererPupupuWaterAotLiveWaterConvertCount, gNdsRendererPupupuWaterAotLiveConvertFrame'
