...
1. A measured evidence packet (per `$smash64ds-measure-frame-pacing`) names the
   exclusive phase, symbol/call chain, dynamic invocation count or bound, and
   useful saving threshold.
