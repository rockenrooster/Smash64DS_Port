# Smash64DS N64 Translation

Project-specific technical companion for Smash64DS_Port. Install as `.agents/skills/n64-to-nds-porting/` and retain both skill names. Replace the previous directory rather than loading multiple revisions.
