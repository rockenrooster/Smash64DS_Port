...
NDS_MARIOFOX_FIGHTER_RELOC_FILES := $(filter-out \
	$(NDS_FTANIM_STREAM_PATTERNS),$(NDS_MARIOFOX_FIGHTER_RELOC_FILES_FULL)) \
	$(filter $(NDS_FTANIM_STREAM_AOBJ32_FILES) $(NDS_FTANIM_STREAM_SPLINE_FILES),$(NDS_MARIOFOX_FIGHTER_RELOC_FILES_FULL))
NDS_P2_FIGHTER_RELOC_FILES := $(filter-out \
	$(NDS_FTANIM_STREAM_PATTERNS),$(NDS_P2_FIGHTER_RELOC_FILES_FULL)) \
	$(filter $(NDS_FTANIM_STREAM_AOBJ32_FILES) $(NDS_FTANIM_STREAM_SPLINE_FILES),$(NDS_P2_FIGHTER_RELOC_FILES_FULL))
endif
...
NDS_NATIVE_CHARGESHOT_PACKET := $(PROJECT_ROOT)/src/nds/generated/nds_native_samus_chargeshot.generated.inc
NDS_NATIVE_CHARGESHOT_HEADER := $(PROJECT_ROOT)/include/nds/generated/nds_native_samus_chargeshot.generated.h
NDS_NATIVE_CHARGESHOT_PREREQ := \
...
ifeq ($(NDS_P2_SAMUS),1)
NDS_SHIELD_POSE_IDS += 03
endif
ifeq ($(NDS_P2_LINK),1)
NDS_SHIELD_POSE_IDS += 05
endif
ifeq ($(NDS_P2_CAPTAIN),1)
NDS_SHIELD_POSE_IDS += 07
endif
ifeq ($(NDS_P2_KIRBY),1)
NDS_SHIELD_POSE_IDS += 08
endif
ifeq ($(NDS_P2_PIKACHU),1)
NDS_SHIELD_POSE_IDS += 09
endif
ifeq ($(NDS_P2_PURIN),1)
...
NDS_SHIELD_POSE_PREREQ := \
	...
	$(BATTLESHIP_O2R)/reloc_fighters_main/PurinShieldPose \
	$(BATTLESHIP_O2R)/reloc_fighters_main/CaptainShieldPose \
	$(BATTLESHIP_O2R)/reloc_fighters_main/PikachuShieldPose
...
NDS_NATIVE_CASTLE_BUMPER_PREREQ := \
	...
	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py
NDS_NATIVE_LINK_BOMB_PACKET := $(PROJECT_ROOT)/src/nds/generated/nds_native_link_bomb.generated.inc
# The adapter admits the bomb in one translation unit and the executor draws
# both of its lists in another, so the pinned constants are a shared header.
NDS_NATIVE_LINK_BOMB_HEADER := $(PROJECT_ROOT)/include/nds/generated/nds_native_link_bomb.generated.h
NDS_NATIVE_LINK_BOMB_PREREQ := \
	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_link_bomb.py \
	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py \
	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h \
	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/it/itfighter/itlinkbomb.c \
	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/it/itdisplay.c \
	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/it/itmanager.c \
...
NDS_NATIVE_ITEM_PORYGON_PACKET := $(PROJECT_ROOT)/src/nds/generated/nds_native_item_porygon.generated.inc
NDS_NATIVE_ITEM_PORYGON_HEADER := $(PROJECT_ROOT)/include/nds/generated/nds_native_item_porygon.generated.h
NDS_NATIVE_ITEM_PORYGON_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_porygon.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
NDS_NATIVE_ITEM_HITOKAGE_PACKET := $(PROJECT_ROOT)/src/nds/generated/nds_native_item_hitokage.generated.inc
NDS_NATIVE_ITEM_HITOKAGE_HEADER := $(PROJECT_ROOT)/include/nds/generated/nds_native_item_hitokage.generated.h
NDS_NATIVE_ITEM_HITOKAGE_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_hitokage.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_yamabuki_live_item.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_STAR_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_star.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_SWORD_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_sword.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_HAMMER_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_hammer.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_MBALL_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_mball.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_GSHELL_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_gshell.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_BAT_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_bat.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_BOMBHEI_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_bombhei.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_RSHELL_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_rshell.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_LGUN_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_lgun.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_HARISEN_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_harisen.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_HEART_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_heart.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_STARROD_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_starrod.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_FFLOWER_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_fflower.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_MSBOMB_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_msbomb.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_NBUMPER_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_nbumper.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_BOX_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_box.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_TARU_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_taru.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_EGG_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_egg.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_IWARK_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_iwark.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_ITEM_CAPSULE_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_capsule.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_wave1_core.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h
...
NDS_NATIVE_INISHIE_POWBLOCK_PACKET := $(PROJECT_ROOT)/src/nds/generated/nds_native_inishie_powblock.generated.inc
NDS_NATIVE_INISHIE_POWBLOCK_HEADER := $(PROJECT_ROOT)/include/nds/generated/nds_native_inishie_powblock.generated.h
NDS_NATIVE_INISHIE_POWBLOCK_PREREQ := 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_inishie_powblock.py 	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py 	$(PROJECT_ROOT)/scripts/stages/native_stage_descriptors/inishie.py 	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/gr/grcommon/grinishie.c 	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/it/itground/itpowerblock.c 	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/relocData/155_StageInishieFile3.c 	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/relocData/260_GRInishieMap.c
NDS_NATIVE_MARUMINE_PACKET := $(PROJECT_ROOT)/src/nds/generated/nds_native_yamabuki_marumine.generated.inc
# The adapter admits the item in one translation unit and the executor draws it
# in another, so the pinned constants are a shared header.
NDS_NATIVE_MARUMINE_HEADER := $(PROJECT_ROOT)/include/nds/generated/nds_native_yamabuki_marumine.generated.h
NDS_NATIVE_MARUMINE_PREREQ := \
	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_yamabuki_marumine.py \
	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py \
	$(PROJECT_ROOT)/decomp/BattleShip-main/include/reloc_data.us.h \
	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/it/itground/itmarumine.c \
	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/it/itdisplay.c \
	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/it/itmanager.c \
	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/lb/lbcommon.c \
	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/gr/grcommon/gryamabuki.c
...
NDS_NATIVE_SECTOR_LASER_HEADER := $(PROJECT_ROOT)/include/nds/generated/nds_native_sector_arwing_laser.generated.h
NDS_NATIVE_SECTOR_LASER_PREREQ := \
	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_sector_arwing_laser.py \
	$(PROJECT_ROOT)/scripts/stages/generate_nds_native_stage.py \
	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/gr/grcommon/grsector.c \
	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/wp/wpmanager.c \
	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/relocData/153_StageSectorFile3.c \
	$(PROJECT_ROOT)/$(BATTLESHIP_DECOMP)/src/relocData/262_GRSectorMap.c
...
$(NDS_NATIVE_CHARGESHOT_PACKET) $(NDS_NATIVE_CHARGESHOT_HEADER) &: $(NDS_NATIVE_CHARGESHOT_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_samus_chargeshot.py" --emit
	@touch $(NDS_NATIVE_CHARGESHOT_PACKET) $(NDS_NATIVE_CHARGESHOT_HEADER)

$(NDS_SHIELD_POSE_HEADER) $(NDS_SHIELD_POSE_MANIFEST) $(NDS_SHIELD_POSE_SOURCE_FILES) &: $(NDS_SHIELD_POSE_PREREQ)
	python "$(PROJECT_ROOT)/scripts/fighters/generate_nds_shield_pose_pack.py" --emit-assets
	@touch $(NDS_SHIELD_POSE_HEADER) $(NDS_SHIELD_POSE_MANIFEST) $(NDS_SHIELD_POSE_SOURCE_FILES)
...
$(NDS_NATIVE_LINK_BOMB_PACKET) $(NDS_NATIVE_LINK_BOMB_HEADER) &: $(NDS_NATIVE_LINK_BOMB_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_link_bomb.py" --emit
	@touch $(NDS_NATIVE_LINK_BOMB_PACKET) $(NDS_NATIVE_LINK_BOMB_HEADER)

$(NDS_NATIVE_MARUMINE_PACKET) $(NDS_NATIVE_MARUMINE_HEADER) &: $(NDS_NATIVE_MARUMINE_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_yamabuki_marumine.py" --emit
	@touch $(NDS_NATIVE_MARUMINE_PACKET) $(NDS_NATIVE_MARUMINE_HEADER)

$(NDS_NATIVE_INISHIE_POWBLOCK_PACKET) $(NDS_NATIVE_INISHIE_POWBLOCK_HEADER) &: $(NDS_NATIVE_INISHIE_POWBLOCK_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_inishie_powblock.py" --emit
	@touch $(NDS_NATIVE_INISHIE_POWBLOCK_PACKET) $(NDS_NATIVE_INISHIE_POWBLOCK_HEADER)

$(NDS_NATIVE_THUNDERJOLT_PACKET) $(NDS_NATIVE_THUNDERJOLT_HEADER) &: $(NDS_NATIVE_THUNDERJOLT_PREREQ)
...
$(NDS_NATIVE_ITEM_GLUCKY_PACKET) $(NDS_NATIVE_ITEM_GLUCKY_HEADER) &: $(NDS_NATIVE_ITEM_GLUCKY_PREREQ)
	...
	@touch $(NDS_NATIVE_ITEM_GLUCKY_PACKET) $(NDS_NATIVE_ITEM_GLUCKY_HEADER)

$(NDS_NATIVE_ITEM_PORYGON_PACKET) $(NDS_NATIVE_ITEM_PORYGON_HEADER) &: $(NDS_NATIVE_ITEM_PORYGON_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_porygon.py" --emit
	@touch $(NDS_NATIVE_ITEM_PORYGON_PACKET) $(NDS_NATIVE_ITEM_PORYGON_HEADER)

$(NDS_NATIVE_ITEM_HITOKAGE_PACKET) $(NDS_NATIVE_ITEM_HITOKAGE_HEADER) &: $(NDS_NATIVE_ITEM_HITOKAGE_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_hitokage.py" --emit
	@touch $(NDS_NATIVE_ITEM_HITOKAGE_PACKET) $(NDS_NATIVE_ITEM_HITOKAGE_HEADER)
...
$(NDS_NATIVE_ITEM_STAR_PACKET) $(NDS_NATIVE_ITEM_STAR_HEADER) &: $(NDS_NATIVE_ITEM_STAR_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_star.py" --emit
...
$(NDS_NATIVE_ITEM_SWORD_PACKET) $(NDS_NATIVE_ITEM_SWORD_HEADER) &: $(NDS_NATIVE_ITEM_SWORD_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_sword.py" --emit
...
$(NDS_NATIVE_ITEM_HAMMER_PACKET) $(NDS_NATIVE_ITEM_HAMMER_HEADER) &: $(NDS_NATIVE_ITEM_HAMMER_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_hammer.py" --emit
...
$(NDS_NATIVE_ITEM_MBALL_PACKET) $(NDS_NATIVE_ITEM_MBALL_HEADER) &: $(NDS_NATIVE_ITEM_MBALL_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_mball.py" --emit
...
$(NDS_NATIVE_ITEM_GSHELL_PACKET) $(NDS_NATIVE_ITEM_GSHELL_HEADER) &: $(NDS_NATIVE_ITEM_GSHELL_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_gshell.py" --emit
...
$(NDS_NATIVE_ITEM_BAT_PACKET) $(NDS_NATIVE_ITEM_BAT_HEADER) &: $(NDS_NATIVE_ITEM_BAT_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_bat.py" --emit
...
$(NDS_NATIVE_ITEM_BOMBHEI_PACKET) $(NDS_NATIVE_ITEM_BOMBHEI_HEADER) &: $(NDS_NATIVE_ITEM_BOMBHEI_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_bombhei.py" --emit
...
$(NDS_NATIVE_ITEM_RSHELL_PACKET) $(NDS_NATIVE_ITEM_RSHELL_HEADER) &: $(NDS_NATIVE_ITEM_RSHELL_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_rshell.py" --emit
...
$(NDS_NATIVE_ITEM_LGUN_PACKET) $(NDS_NATIVE_ITEM_LGUN_HEADER) &: $(NDS_NATIVE_ITEM_LGUN_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_lgun.py" --emit
...
$(NDS_NATIVE_ITEM_HARISEN_PACKET) $(NDS_NATIVE_ITEM_HARISEN_HEADER) &: $(NDS_NATIVE_ITEM_HARISEN_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_harisen.py" --emit
...
$(NDS_NATIVE_ITEM_HEART_PACKET) $(NDS_NATIVE_ITEM_HEART_HEADER) &: $(NDS_NATIVE_ITEM_HEART_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_heart.py" --emit
...
$(NDS_NATIVE_ITEM_STARROD_PACKET) $(NDS_NATIVE_ITEM_STARROD_HEADER) &: $(NDS_NATIVE_ITEM_STARROD_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_starrod.py" --emit
...
$(NDS_NATIVE_ITEM_FFLOWER_PACKET) $(NDS_NATIVE_ITEM_FFLOWER_HEADER) &: $(NDS_NATIVE_ITEM_FFLOWER_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_fflower.py" --emit
...
$(NDS_NATIVE_ITEM_MSBOMB_PACKET) $(NDS_NATIVE_ITEM_MSBOMB_HEADER) &: $(NDS_NATIVE_ITEM_MSBOMB_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_msbomb.py" --emit
...
$(NDS_NATIVE_ITEM_NBUMPER_PACKET) $(NDS_NATIVE_ITEM_NBUMPER_HEADER) &: $(NDS_NATIVE_ITEM_NBUMPER_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_nbumper.py" --emit
...
$(NDS_NATIVE_ITEM_BOX_PACKET) $(NDS_NATIVE_ITEM_BOX_HEADER) &: $(NDS_NATIVE_ITEM_BOX_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_box.py" --emit
...
$(NDS_NATIVE_ITEM_TARU_PACKET) $(NDS_NATIVE_ITEM_TARU_HEADER) &: $(NDS_NATIVE_ITEM_TARU_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_taru.py" --emit
...
$(NDS_NATIVE_ITEM_EGG_PACKET) $(NDS_NATIVE_ITEM_EGG_HEADER) &: $(NDS_NATIVE_ITEM_EGG_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_egg.py" --emit
...
$(NDS_NATIVE_ITEM_IWARK_PACKET) $(NDS_NATIVE_ITEM_IWARK_HEADER) &: $(NDS_NATIVE_ITEM_IWARK_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_iwark.py" --emit
...
$(NDS_NATIVE_ITEM_CAPSULE_PACKET) $(NDS_NATIVE_ITEM_CAPSULE_HEADER) &: $(NDS_NATIVE_ITEM_CAPSULE_PREREQ)
	python "$(PROJECT_ROOT)/scripts/stages/generate_nds_native_item_capsule.py" --emit
...
$(NDS_NATIVE_SECTOR_LASER_PACKET) $(NDS_NATIVE_SECTOR_LASER_HEADER) &: $(NDS_NATIVE_SECTOR_LASER_PREREQ)
	...
	@touch $(NDS_NATIVE_SECTOR_LASER_PACKET) $(NDS_NATIVE_SECTOR_LASER_HEADER)
...
nds_shield_pose.o: $(if $(strip $(NDS_SHIELD_POSE_IDS)),$(NDS_SHIELD_POSE_HEADER))
nds_renderer.o: $(NDS_NATIVE_ITEM_BAT_PACKET) $(NDS_NATIVE_ITEM_BAT_HEADER) $(NDS_NATIVE_ITEM_BOMBHEI_PACKET) $(NDS_NATIVE_ITEM_BOMBHEI_HEADER) $(NDS_NATIVE_ITEM_RSHELL_PACKET) $(NDS_NATIVE_ITEM_RSHELL_HEADER) $(NDS_NATIVE_ITEM_LGUN_PACKET) $(NDS_NATIVE_ITEM_LGUN_HEADER) $(NDS_NATIVE_ITEM_HARISEN_PACKET) $(NDS_NATIVE_ITEM_HARISEN_HEADER) $(NDS_NATIVE_ITEM_HEART_PACKET) $(NDS_NATIVE_ITEM_HEART_HEADER) $(NDS_NATIVE_ITEM_STARROD_PACKET) $(NDS_NATIVE_ITEM_STARROD_HEADER) $(NDS_NATIVE_ITEM_FFLOWER_PACKET) $(NDS_NATIVE_ITEM_FFLOWER_HEADER) $(NDS_NATIVE_ITEM_MSBOMB_PACKET) $(NDS_NATIVE_ITEM_MSBOMB_HEADER) $(NDS_NATIVE_ITEM_NBUMPER_PACKET) $(NDS_NATIVE_ITEM_NBUMPER_HEADER) $(NDS_NATIVE_ITEM_BOX_PACKET) $(NDS_NATIVE_ITEM_BOX_HEADER) $(NDS_NATIVE_ITEM_TARU_PACKET) $(NDS_NATIVE_ITEM_TARU_HEADER) $(NDS_NATIVE_ITEM_EGG_PACKET) $(NDS_NATIVE_ITEM_EGG_HEADER) $(NDS_NATIVE_ITEM_IWARK_PACKET) $(NDS_NATIVE_ITEM_IWARK_HEADER) $(NDS_NATIVE_ITEM_STAR_PACKET) $(NDS_NATIVE_ITEM_STAR_HEADER) $(NDS_NATIVE_ITEM_SWORD_PACKET) $(NDS_NATIVE_ITEM_SWORD_HEADER) $(NDS_NATIVE_ITEM_HAMMER_PACKET) $(NDS_NATIVE_ITEM_HAMMER_HEADER) $(NDS_NATIVE_ITEM_MBALL_PACKET) $(NDS_NATIVE_ITEM_MBALL_HEADER) $(NDS_NATIVE_ITEM_GSHELL_PACKET) $(NDS_NATIVE_ITEM_GSHELL_HEADER) $(NDS_NATIVE_ITEM_GLUCKY_PACKET) $(NDS_NATIVE_ITEM_GLUCKY_HEADER) $(NDS_NATIVE_ITEM_PORYGON_PACKET) $(NDS_NATIVE_ITEM_PORYGON_HEADER) $(NDS_NATIVE_ITEM_HITOKAGE_PACKET) $(NDS_NATIVE_ITEM_HITOKAGE_HEADER) $(NDS_NATIVE_ITEM_FUSHIGIBANA_PACKET) $(NDS_NATIVE_ITEM_FUSHIGIBANA_HEADER) $(NDS_ENTRY_EFFECT_INC) $(NDS_PARTICLE_BANKS_INC) $(NDS_NATIVE_ACTOR_YOSTER_PACKET) $(NDS_NATIVE_ACTOR_LAKITU_PACKET) $(NDS_NATIVE_ACTOR_BRONTO_PACKET) $(NDS_NATIVE_ACTOR_TARU_PACKET) $(NDS_NATIVE_ACTOR_TARU_HEADER) $(NDS_NATIVE_SECTOR_LASER_PACKET) $(NDS_NATIVE_SECTOR_LASER_HEADER) $(NDS_NATIVE_CASTLE_BUMPER_PACKET) $(NDS_NATIVE_CASTLE_BUMPER_HEADER) $(NDS_NATIVE_LINK_BOMB_PACKET) $(NDS_NATIVE_LINK_BOMB_HEADER) $(NDS_NATIVE_MARUMINE_PACKET) $(NDS_NATIVE_MARUMINE_HEADER) $(NDS_NATIVE_INISHIE_POWBLOCK_PACKET) $(NDS_NATIVE_INISHIE_POWBLOCK_HEADER) $(NDS_NATIVE_THUNDERJOLT_PACKET) $(NDS_NATIVE_THUNDERJOLT_HEADER) $(NDS_NATIVE_THUNDERGROUND_PACKET) $(NDS_NATIVE_THUNDERGROUND_HEADER) $(NDS_NATIVE_THUNDERJOLTFX_PACKET) $(NDS_NATIVE_THUNDERJOLTFX_HEADER) $(NDS_NATIVE_DAMAGE_SLASH_PACKET) $(NDS_NATIVE_DAMAGE_SLASH_HEADER) $(NDS_NATIVE_ITEM_TOMATO_PACKET) $(NDS_NATIVE_ITEM_TOMATO_HEADER) $(NDS_NATIVE_CHARGESHOT_PACKET) $(NDS_NATIVE_CHARGESHOT_HEADER) $(NDS_NATIVE_OWNER_IR) $(NDS_NATIVE_IMAGE_HEADER)
scene_backend.o: $(NDS_NATIVE_ITEM_BAT_HEADER) $(NDS_NATIVE_ITEM_BOMBHEI_HEADER) $(NDS_NATIVE_ITEM_RSHELL_HEADER) $(NDS_NATIVE_ITEM_LGUN_HEADER) $(NDS_NATIVE_ITEM_HARISEN_HEADER) $(NDS_NATIVE_ITEM_HEART_HEADER) $(NDS_NATIVE_ITEM_STARROD_HEADER) $(NDS_NATIVE_ITEM_FFLOWER_HEADER) $(NDS_NATIVE_ITEM_MSBOMB_HEADER) $(NDS_NATIVE_ITEM_NBUMPER_HEADER) $(NDS_NATIVE_ITEM_BOX_HEADER) $(NDS_NATIVE_ITEM_TARU_HEADER) $(NDS_NATIVE_ITEM_EGG_HEADER) $(NDS_NATIVE_ITEM_IWARK_HEADER) $(NDS_NATIVE_ITEM_STAR_HEADER) $(NDS_NATIVE_ITEM_SWORD_HEADER) $(NDS_NATIVE_ITEM_HAMMER_HEADER) $(NDS_NATIVE_ITEM_MBALL_HEADER) $(NDS_NATIVE_ITEM_GSHELL_HEADER) $(NDS_NATIVE_ITEM_GLUCKY_HEADER) $(NDS_NATIVE_ITEM_PORYGON_HEADER) $(NDS_NATIVE_ITEM_HITOKAGE_HEADER) $(NDS_NATIVE_ITEM_FUSHIGIBANA_HEADER) $(NDS_NATIVE_SECTOR_LASER_HEADER) $(NDS_NATIVE_CASTLE_BUMPER_HEADER) $(NDS_NATIVE_LINK_BOMB_HEADER) $(NDS_NATIVE_MARUMINE_HEADER) $(NDS_NATIVE_INISHIE_POWBLOCK_HEADER) $(NDS_NATIVE_THUNDERJOLT_HEADER) $(NDS_NATIVE_THUNDERGROUND_HEADER) $(NDS_NATIVE_THUNDERJOLTFX_HEADER) $(NDS_NATIVE_DAMAGE_SLASH_HEADER) $(NDS_NATIVE_ITEM_TOMATO_HEADER) $(NDS_NATIVE_CHARGESHOT_HEADER)
...
# nds_renderer_assets.c is textually included by nds_renderer.c (line 2), so
# the object that consumes this header is nds_renderer.o. Until 2026-09-07 the
# dependency named nds_renderer_assets.o, an object no rule ever builds, so the
# header was never generated, __has_include silently took the "no blob stages"
# arm, and every blob stage with more dense vertices than Dream Land overflowed
# the validator's stack mask and was rejected with reason 6.
nds_renderer.o: $(NDS_NATIVE_STAGE_BLOB_MAXIMA_INC)
...
$(NDS_ENTRY_EFFECT_INC): \
		...
		$(BATTLESHIP_O2R)/reloc_effects/EFCommonEffects3 \
