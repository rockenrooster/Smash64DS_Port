...
NDS_IMPORT_BATTLESHIP_MARIO_SPECIAL_HI ?= 0
NDS_IMPORT_BATTLESHIP_MARIO_SPECIAL_LW ?= 0
NDS_IMPORT_BATTLESHIP_FOX_SPECIAL_HI ?= 0
...
CFLAGS += -DNDS_IMPORT_BATTLESHIP_FOX_REFLECTOR=$(NDS_IMPORT_BATTLESHIP_FOX_REFLECTOR)
CFLAGS += -DNDS_IMPORT_BATTLESHIP_MARIO_SPECIAL_HI=$(NDS_IMPORT_BATTLESHIP_MARIO_SPECIAL_HI)
...
NDS_SCENE_HARNESS_AWARE_OFILES := scene_backend.o scene_harness.o battleship_grinishie_scale.o
...
$(OUTPUT).elf: $(OFILES)
$(OFILES): $(PROJECT_ROOT)/Makefile
$(NDS_SCENE_HARNESS_AWARE_OFILES): $(NDS_SCENE_HARNESS_CONFIG)
