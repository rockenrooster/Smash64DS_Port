...
scene_backend.o: $(NDS_NATIVE_SECTOR_LASER_HEADER) $(NDS_NATIVE_CASTLE_BUMPER_HEADER) $(NDS_NATIVE_LINK_BOMB_HEADER) $(NDS_NATIVE_MARUMINE_HEADER) $(NDS_NATIVE_INISHIE_POWBLOCK_HEADER) $(NDS_NATIVE_THUNDERJOLT_HEADER) $(NDS_NATIVE_CHARGESHOT_HEADER)
