...
`33/34`, stage draw/collision/floor-follow/floor-edge/MP process/update-floor modes `59-70`, and Boundary/Latest pair
...
stage-inclusive `gcDrawAll`/collision/floor-follow/floor-edge/MP process/update-floor defaults now submit the Pupupu stage plus
...
`artifacts\stage-floor-follow-hwtri.png`, `artifacts\stage-floor-edge-hwtri.png`, `artifacts\stage-mpprocess-floor-hwtri.png`, `artifacts\stage-mpupdate-floor-hwtri.png`,
