...
Landed today: P2-3f50 and P2-3f51 closed (see board); the animation cache now
keeps the match's fighter cost free before reserving, which unblocked the
ten-flag ROM; dense normals moved into the NitroFS owner images (−21,928 B);
Yoshi's Island landed its gameplay half behind `NDS_P2_STAGE_YOSTER`.
...
4. Then Kirby copy, the four-CPU stress arm (P2-3f46), Link acceptance.
