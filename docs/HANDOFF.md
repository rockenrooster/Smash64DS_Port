...
`33/34`, stage draw/collision/floor-follow/floor-edge modes `59-66`, and Boundary/Latest pair
...
stage-inclusive `gcDrawAll`/collision/floor-follow/floor-edge defaults now submit the Pupupu stage plus
...
`artifacts\stage-floor-follow-hwtri.png`, `artifacts\stage-floor-edge-hwtri.png`,
