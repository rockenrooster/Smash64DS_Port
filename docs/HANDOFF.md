...
`33/34`, stage draw/collision/floor-follow modes `59-64`, and active Boundary/Latest pair
...
stage-inclusive `gcDrawAll`/collision/floor-follow defaults now submit the Pupupu stage plus
...
`artifacts\stage-floor-follow-hwtri.png`,
