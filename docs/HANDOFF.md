...
4. **P2-6** driver, bonus stages and the stage-clear table build behind
   `NDS_P2_1P_GAME`; `scripts/menus/stage_reloc_file.py --file X --list
   NDS_1P_RELOC_FILES` stages a sprite reloc file on all five surfaces.
