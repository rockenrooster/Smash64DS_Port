...
Read the board's **Current integration checkpoint**, then select the
highest-impact ready unowned package under its existing ID/phase. Read only its
relevant source/assets and owner docs; use CodeGraph first where available.
Do not restart P2 or re-import implemented systems.
