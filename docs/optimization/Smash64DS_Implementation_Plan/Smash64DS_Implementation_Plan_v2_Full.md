# Smash64DS exhaustive implementation plan — revision 2

**Scope:** every legal four-fighter lineup on every selectable VS stage, including duplicates and legal slot assignments.

**81 task cards · 11 packages · 18 documents.** Static specification only; no new ROM benchmark. Original source baseline `75f7f6b4b4864c82c01872d0fd2771d171005272`; repository rechecked at `e67e5871ba8c4ae972f4826bfeb89757d3686401`.

## Contents

- [00_MASTER.md](#document-00-master)
- [01_CONTRACTS.md](#document-01-contracts)
- [02_BASELINE_AND_GATES.md](#document-02-baseline-and-gates)
- [03_TCM_AND_BUILD.md](#document-03-tcm-and-build)
- [04_RESIDENCY_AND_ASSETS.md](#document-04-residency-and-assets)
- [05_BOUND_RENDERER.md](#document-05-bound-renderer)
- [06_PACKET_COMPILER.md](#document-06-packet-compiler)
- [07_FIXED_NUMERICS.md](#document-07-fixed-numerics)
- [08_EVENTS_AND_POSE.md](#document-08-events-and-pose)
- [09_GAMEPLAY_COLLISION_AI.md](#document-09-gameplay-collision-ai)
- [10_STAGE_VFX_UI.md](#document-10-stage-vfx-ui)
- [11_AUDIO_AND_OFFLOAD.md](#document-11-audio-and-offload)
- [12_FINAL_PACK_AND_RETIREMENT.md](#document-12-final-pack-and-retirement)
- [13_AGENT_EXECUTION.md](#document-13-agent-execution)
- [14_VALIDATION.md](#document-14-validation)
- [15_SOURCE_INDEX.md](#document-15-source-index)
- [16_ALL_ROSTERS_ALL_STAGES.md](#document-16-all-rosters-all-stages)
- [README.md](#document-readme)

---

<a id="document-00-master"></a>

<!-- Source document: docs/p2/native-optimization/00_MASTER.md -->
...
Sources: [S01, S02, S03, S04, S05, S06] in [15_SOURCE_INDEX.md](#document-15-source-index).
...
[16_ALL_ROSTERS_ALL_STAGES.md](#document-16-all-rosters-all-stages) defines exact coverage sets, permutations, per-case gates, resume/invalidation, additional task cards and negative tests. **Pairwise sampling is a development aid and supplemental interaction technique, not release base-case coverage.** Rare exceptional frames remain allowed under the existing P95/cadence contract; this revision does not require every individual frame to stay below budget.
...
<a id="document-01-contracts"></a>

<!-- Source document: docs/p2/native-optimization/01_CONTRACTS.md -->
...
<a id="document-02-baseline-and-gates"></a>

<!-- Source document: docs/p2/native-optimization/02_BASELINE_AND_GATES.md -->

# N00 — Baseline, opportunity ledger and explicit gates

> **Revision 2 coverage:** The fixed current four-kind run is the initial regression/attribution anchor only. N00.06 defines the full required roster-stage universe early; N00.04 grades each scenario independently. Exhaustive runs belong to release qualification, not every edit. See [16_ALL_ROSTERS_ALL_STAGES.md](#document-16-all-rosters-all-stages).
...
<a id="document-05-bound-renderer"></a>

<!-- Source document: docs/p2/native-optimization/05_BOUND_RENDERER.md -->

# N03A — Bound native renderer and mutation-owned preparation

> **Revision 2 coverage:** Universal scope: the simple actor and hot-fighter pilots establish the interface and cost, not a supported-roster allowlist. N03.11 proves independent same-kind instances and explicit slot-sensitive behavior before the renderer family is closed. See [16_ALL_ROSTERS_ALL_STAGES.md](#document-16-all-rosters-all-stages).
...
<a id="document-07-fixed-numerics"></a>

<!-- Source document: docs/p2/native-optimization/07_FIXED_NUMERICS.md -->

# N04 — Whole-domain fixed numerics

> **Revision 2 coverage:** Universal scope: fixed ranges and no-float closure include every required fighter, stage, legal variant, effect, service and cold scene. The current stress roster is not an adequate numeric range proof. See [16_ALL_ROSTERS_ALL_STAGES.md](#document-16-all-rosters-all-stages).
...
<a id="document-09-gameplay-collision-ai"></a>

<!-- Source document: docs/p2/native-optimization/09_GAMEPLAY_COLLISION_AI.md -->

# N06 — Compact fixed gameplay, collision, AI and scheduling

> **Revision 2 coverage:** Universal scope: all ordered fighter interactions, legal slot/team/control settings and every stage collision/hazard class are supported. Six unordered broad pairs never replace directed hit/grab/reflect outcomes; level-3 CPU profiling is not an AI cost upper bound. See [16_ALL_ROSTERS_ALL_STAGES.md](#document-16-all-rosters-all-stages).
...
<a id="document-10-stage-vfx-ui"></a>

<!-- Source document: docs/p2/native-optimization/10_STAGE_VFX_UI.md -->

# N07 — Stage, effects, particles and UI

> **Revision 2 coverage:** Universal scope: every selectable VS stage must remain complete with any legal four-fighter lineup. Maintain separate GPU/overdraw, geometry/matrix, native-ordering and memory/service leaders instead of assuming the CPU leader stresses all resources. See [16_ALL_ROSTERS_ALL_STAGES.md](#document-16-all-rosters-all-stages).
...
<a id="document-12-final-pack-and-retirement"></a>

<!-- Source document: docs/p2/native-optimization/12_FINAL_PACK_AND_RETIREMENT.md -->

# N09 — Final retirement, hot-data/code placement and kernel tuning

> **Revision 2 coverage:** Universal scope: final no-float, reachability and TCM retirement cover all required content, not merely the pilot ROM call graph. Final layout changes conservatively stale timing evidence; N10 requalifies the declared case universe. See [16_ALL_ROSTERS_ALL_STAGES.md](#document-16-all-rosters-all-stages).
...
<a id="document-13-agent-execution"></a>

<!-- Source document: docs/p2/native-optimization/13_AGENT_EXECUTION.md -->
...
<a id="document-14-validation"></a>

<!-- Source document: docs/p2/native-optimization/14_VALIDATION.md -->
...
The complete algorithm, identities, proof scopes, negative fixtures **COV01–COV18** and six additional task cards are in [16_ALL_ROSTERS_ALL_STAGES.md](#document-16-all-rosters-all-stages). N10.01 freezes obligations; N00.06 enumerates; N02.07 checks resource feasibility; N03.11 checks duplicate/slot behavior; N10.07 runs; N10.08 reconciles; N10.09 targets adverse interactions.
...
<a id="document-15-source-index"></a>

<!-- Source document: docs/p2/native-optimization/15_SOURCE_INDEX.md -->
...
<a id="document-16-all-rosters-all-stages"></a>

<!-- Source document: docs/p2/native-optimization/16_ALL_ROSTERS_ALL_STAGES.md -->
...
<a id="document-readme"></a>

<!-- Source document: docs/p2/native-optimization/README.md -->
...
Read [00_MASTER.md](#document-00-master), then the assigned package, relevant contracts in [01_CONTRACTS.md](#document-01-contracts), and its tests in [14_VALIDATION.md](#document-14-validation). Do not reread the whole research report on every restart.
...
| File | Purpose |
|---|---|
| [00_MASTER.md](#document-00-master) | Decisions, sequence, budgets, first commits and integration rules |
| [01_CONTRACTS.md](#document-01-contracts) | Native numeric, ownership, mutation, resource and packet interfaces |
| [02_BASELINE_AND_GATES.md](#document-02-baseline-and-gates) | Reproducible measurement; explicit product gate |
| [03_TCM_AND_BUILD.md](#document-03-tcm-and-build) | Bounded early ITCM reclamation, build/telemetry cleanup |
| [04_RESIDENCY_AND_ASSETS.md](#document-04-residency-and-assets) | Memory recovery and deterministic pre-GO asset admission |
| [05_BOUND_RENDERER.md](#document-05-bound-renderer) | Binding and dynamic-update separation; eliminate source-shaped prep |
| [06_PACKET_COMPILER.md](#document-06-packet-compiler) | Generated native GX streams, patching and hardware lifetime |
| [07_FIXED_NUMERICS.md](#document-07-fixed-numerics) | Numeric graph, fixed primitives, constants and no-float closure |
| [08_EVENTS_AND_POSE.md](#document-08-events-and-pose) | Event timing, compact pose, required sockets and transform reuse |
| [09_GAMEPLAY_COLLISION_AI.md](#document-09-gameplay-collision-ai) | Fixed gameplay, collision, shared query facts and ordering |
| [10_STAGE_VFX_UI.md](#document-10-stage-vfx-ui) | Static/dynamic stage split, particles and native UI |
| [11_AUDIO_AND_OFFLOAD.md](#document-11-audio-and-offload) | Audio/storage bounds and justified DMA/ARM7/math offload |
| [12_FINAL_PACK_AND_RETIREMENT.md](#document-12-final-pack-and-retirement) | Whole-runtime cleanup, TCM tuning and release closure |
| [13_AGENT_EXECUTION.md](#document-13-agent-execution) | Task handoffs, source ownership, safe integration and example commands |
| [14_VALIDATION.md](#document-14-validation) | Concrete regression, negative, coverage and acceptance tests |
| [15_SOURCE_INDEX.md](#document-15-source-index) | Immutable evidence anchors; what is known versus proposed |
| [16_ALL_ROSTERS_ALL_STAGES.md](#document-16-all-rosters-all-stages) | Universal scope, exhaustive base/ordered cases, resource and timing proof, added tasks |
