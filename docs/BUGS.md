...
-Hyrule: stage edge geometry seems to be drawing over stage front face geometry instead of the other way around, maybe backface rendering turned off fixes it? Tornadoes seem to do too much DMG and throw character horizontally. — Range-run scale repaired 2026-09-07 (matrix shift); depth order and tornado contract investigating. backface/depth rendering error at geometry boundaries:
