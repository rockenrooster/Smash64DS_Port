...
draw/collision/floor-follow/floor-edge/MP process/update/sweep/cross/adjust/edge/wall/stale/live-stale/motion-stale/cliff-status/cliff-tick/fall-map/fall-landing/ceiling/ceiling-status/cliff-catch/cliff-wait/cliff-attack/cliff-attack-action/cliff-common2 modes `59-108`, and Boundary/Latest pair `161/162`;
...
`artifacts\boundary-combat-hwtri.png`, the stage MP hardware captures through cliff-common2,
