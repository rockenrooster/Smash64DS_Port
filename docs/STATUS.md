...
draw/collision/floor-follow/floor-edge/MP process-floor modes `59-68`, and Boundary/Latest pair `161/162`;
...
palette. The stage `gcDrawAll`/collision/floor-follow/floor-edge/MP process-floor hardware defaults now submit the
...
`artifacts\stage-floor-follow-hwtri.png`, `artifacts\stage-floor-edge-hwtri.png`, `artifacts\stage-mpprocess-floor-hwtri.png`, menu-chain all-DL HW, and
