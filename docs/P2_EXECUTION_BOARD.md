...
2.53M, Link entry failures 0. **Slice 2c in progress**: whole admission with no
new RAM (compact cache keys, own VRAM carve), exit and creation-time paths. Alongside (disjoint files, integrator): MF host
