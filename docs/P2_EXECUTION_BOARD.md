...
| P2-4 Stage production | **REOPENED — native admission repaired `ab3a8f083e4`; art/hazard acceptance open** | All eight blob stages declined with reason 6 (missing maxima header, segment-0 flag); Jungle/Castle now admit natively. Per-stage acceptance, actors (barrel path, clouds, gate, acid, Arwing) and pipes remain; `docs/BUGS.md` holds the owner's list. |
