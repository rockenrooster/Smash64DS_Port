...
| P2-4 Stage production | **REOPENED — admission repaired; Zebes crash + acid depth fixed `467dbefc532`** | All eight admit; event32 ledger 5,120 (Zebes needs ~2,400). Open per `docs/BUGS.md`: barrel, Hyrule depth/tornado, Castle roof, Yoster floor/alpha, Inishie platforms/BGM/FPS, Sector Arwing, Saffron wall/door. |
