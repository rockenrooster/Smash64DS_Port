...
| Pause-orbit geometry containment | FIXED / focused pass | Renderer + QA | Ten slightly out-of-range exact-stage triangles now use a scaled raw matrix and DS near-plane clipping; normal/front/+33.6° automated captures pass, and Tyler accepted the repaired view | Keep the focused deterministic camera gate |
