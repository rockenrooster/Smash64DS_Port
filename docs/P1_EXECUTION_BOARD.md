...
| Locked-30 scheduler | Pass / slowdown published | Integration | Task 9 natural match: 4,084 updates / 2,042 presents, exact fixed-two pacing; phase rates 39.9/37.4/39.3/n.a./58.2 updates/s and slips 196/1088/946/0/3. Current profile-0 smoke is 20.2 FPS. Focused natural KO/rebirth active P95 is 1,524,864/1,112,256 ticks | Keep exact 2:1 and conditional 59.0–61.0 gates; full-speed locked 30 remains unmet |
...
| Focused/checkpoint verification | Current PASS / focused Down-Air PASS | QA | Published battle candidate `792F1A76...` passes the 20:19 Current checkpoint with runtime, mode-163 CPU, GBI fixtures, two-ROM publication, 28,020-byte ITCM placement, and dated visual analysis. Focused Fox-P2 and Mario routes both complete Down-Air naturally with source assets and reserve above 200 KiB | Keep this shared-runtime checkpoint; the countdown and Down+A findings are fixed |
| Cut G capture / final dated capture / manual retest | Automated exactness pass / manual current-ROM retest pending | QA + user | Current capture is `2026-07-17_canonical_fast_201930-8609498-p53076.png`; Task 6 C/D, Task 8 G2, reserve repair, Task 9 state identity, source-light parity, the M2 capture-reset cut, raw-corner cut, and Down+A shared-seam fix remain retained | Manually retest exact ROM `792F1A76...`; automated Down+A closure is complete |
