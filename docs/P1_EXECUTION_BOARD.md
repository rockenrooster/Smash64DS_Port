...
| M2 Mario/Fox AOT, 170–250K ticks | Incremental compute KEEP at 386.9K | Renderer | Current Mode-8 A/B moves combined fighter P50/P95 395,264/395,328 → 386,880/386,944 by AOT-packing the immutable DS `VERTEX16` words in the existing 16-byte dense record. Exact 70/686 and 60/320/306/29/0/0 remain, conservation is zero, and the native top-screen image is byte-identical | Keep ITCM, exact quantization, raw-loop specialization, batched accounting, and AOT GX coordinates; lighting is already a bare exact LUT path. Continue the measured production emit path. The 170–250K milestone is directional, not an intermediate discard gate |
