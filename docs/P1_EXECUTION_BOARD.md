...
| M2 Mario/Fox AOT, 170–250K ticks | Incremental compute KEEP at 398.0K | Renderer | Current Mode-8 A/B moves combined fighter P50/P95 402,560/402,624 → 398,048/398,144 by replacing only exact power-of-two float-to-fixed conversions in the fighter local builder. Exact 70/686 and 60/320/306/29/0/0 remain, conservation is zero, and Tyler confirmed the candidate PNG is visually normal | Keep ITCM and exact quantization cuts; lighting is already a bare exact LUT path. Continue the measured production emit/account path. The 170–250K milestone is directional, not an intermediate discard gate |
