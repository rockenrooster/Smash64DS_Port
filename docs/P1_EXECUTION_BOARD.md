...
| M2 Mario/Fox AOT, 170–250K ticks | Incremental compute KEEP at 397.2K | Renderer | Current Mode-8 A/B moves combined fighter P50/P95 398,048/398,144 → 397,248/397,312 by specializing the already-complete 582-triangle raw production emitter outside its corner loop. Exact 70/686 and 60/320/306/29/0/0 remain, conservation is zero, and the native top-screen image is byte-identical | Keep ITCM, exact quantization, and raw-loop specialization; lighting is already a bare exact LUT path. Continue the measured production emit/account path. The 170–250K milestone is directional, not an intermediate discard gate |
