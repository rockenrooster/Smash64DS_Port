...
| M3 complete stage AOT, 150–250K ticks | Semantic pass / accumulated KEEP at 556K | Renderer | Current bitmap-OAM A/B moves stage 578,272/578,560 → 556,256/556,352 and draw 997,440/997,504 → 975,360/975,488 by AOT-packing immutable GX coordinate shifts. Exact 121/828, 57/42/54/202/49/4, cross 5/10/15, zero fallback/fence, and 0/240,000 changed DS-screen pixels hold | Keep no-Z codegen, dense prepare-once, and AOT shifts; continue the measured 174.6K no-Z/146-matrix-load path. 500K remains a target, not a discard gate |
