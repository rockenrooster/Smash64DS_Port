...
| M2 Mario/Fox AOT, 170–250K ticks | Incremental compute KEEP at 395.3K | Renderer | Current Mode-8 A/B moves combined fighter P50/P95 397,248/397,312 → 395,264/395,328 by aggregating the complete raw/cross owner accounting once per fighter traversal. Exact 70/686 and 60/320/306/29/0/0 remain, conservation is zero, and the native top-screen image is byte-identical | Keep ITCM, exact quantization, raw-loop specialization, and batched accounting; lighting is already a bare exact LUT path. Continue the measured production emit path. The 170–250K milestone is directional, not an intermediate discard gate |
