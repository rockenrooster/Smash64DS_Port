...
#define ACTIVE_FLAG_DITHERED_ALPHA         (1 <<  7)
...
#define DIALOG_FLAG_TURN_TO_MARIO       (1 << 0)
#define DIALOG_FLAG_TEXT_DEFAULT        (1 << 1)
#define DIALOG_FLAG_TEXT_RESPONSE       (1 << 2)
#define DIALOG_FLAG_UNK_CAPSWITCH       (1 << 3)
#define DIALOG_FLAG_TIME_STOP_ENABLED   (1 << 4)
...
#define ACTIVE_PARTICLE_DUST                 (1 <<  0)
#define ACTIVE_PARTICLE_UNUSED_1             (1 <<  1)
#define ACTIVE_PARTICLE_UNUSED_2             (1 <<  2)
#define ACTIVE_PARTICLE_SPARKLES             (1 <<  3)
#define ACTIVE_PARTICLE_H_STAR               (1 <<  4)
#define ACTIVE_PARTICLE_BUBBLE               (1 <<  5)
#define ACTIVE_PARTICLE_WATER_SPLASH         (1 <<  6)
#define ACTIVE_PARTICLE_IDLE_WATER_WAVE      (1 <<  7)
#define ACTIVE_PARTICLE_SHALLOW_WATER_WAVE   (1 <<  8)
#define ACTIVE_PARTICLE_PLUNGE_BUBBLE        (1 <<  9)
#define ACTIVE_PARTICLE_WAVE_TRAIL           (1 << 10)
#define ACTIVE_PARTICLE_FIRE                 (1 << 11)
#define ACTIVE_PARTICLE_SHALLOW_WATER_SPLASH (1 << 12)
#define ACTIVE_PARTICLE_LEAF                 (1 << 13)
#define ACTIVE_PARTICLE_DIRT                 (1 << 14)
#define ACTIVE_PARTICLE_MIST_CIRCLE          (1 << 15)
#define ACTIVE_PARTICLE_SNOW                 (1 << 16)
#define ACTIVE_PARTICLE_BREATH               (1 << 17)
#define ACTIVE_PARTICLE_V_STAR               (1 << 18)
#define ACTIVE_PARTICLE_TRIANGLE             (1 << 19)
...
#define TTC_SPEED_STOPPED 3
    ...
    #define BOWSER_ANIM_STAND_UP_UNUSED     1
    #define BOWSER_ANIM_SHAKING             2
    #define BOWSER_ANIM_GRABBED             3
    #define BOWSER_ANIM_BROKEN              4
    #define BOWSER_ANIM_FALL_DOWN           5
    #define BOWSER_ANIM_BREATH              6
    #define BOWSER_ANIM_JUMP                7
    ...
    #define BOWSER_STATUS_ANGLE_MARIO   (1 <<  1)
    #define BOWSER_STATUS_ANGLE_CENTER  (1 <<  2)
    #define BOWSER_STATUS_DIST_MARIO    (1 <<  3)
    #define BOWSER_STATUS_DIST_CENTER   (1 <<  4)
    #define BOWSER_STATUS_BIG_JUMP      (1 << 16)
    #define BOWSER_STATUS_FIRE_SKY      (1 << 17)
