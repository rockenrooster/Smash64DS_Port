...
const BehaviorScript bhvMrI[] = {
    ...
    SET_HOME(),
    SPAWN_CHILD( MODEL_MR_I_IRIS,  bhvMrIBody),
...
const BehaviorScript bhvKingBobomb[] = {
    ...
    DROP_TO_FLOOR(),
    SET_HOME(),
    SPAWN_OBJ( MODEL_NONE,  bhvBobombAnchorMario),
    SET_INT(oHealth, 3),
    SET_INT(oDamageOrCoinValue, 1),
    BEGIN_LOOP(),
...
const BehaviorScript bhvBubbleParticleSpawner[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    DISABLE_RENDERING(),
    SET_RANDOM_INT(oWaterObjUnkF4,  2,  9),
    DELAY_VAR(oWaterObjUnkF4),
    SPAWN_CHILD( MODEL_BUBBLE,  bhvSmallWaterWave),
...
const BehaviorScript bhvBubbleMaybe[] = {
    ...
    SET_RANDOM_FLOAT(oWaterObjUnkF4,  -75,  150),
    SET_RANDOM_FLOAT(oWaterObjUnkF8,  -75,  150),
    SET_RANDOM_FLOAT(oWaterObjUnkFC,  -75,  150),
    SUM_FLOAT( oPosX,  oPosX,  oWaterObjUnkF4),
    SUM_FLOAT( oPosZ,  oPosZ,  oWaterObjUnkF8),
    SUM_FLOAT( oPosY,  oPosY,  oWaterObjUnkFC),
...
const BehaviorScript bhvSmallWaterWave[] = {
    ...
    BILLBOARD(),
    CALL_NATIVE(bhv_bubble_wave_init),
    SET_RANDOM_FLOAT(oWaterObjUnkF4,  -50,  100),
    SET_RANDOM_FLOAT(oWaterObjUnkF8,  -50,  100),
    SUM_FLOAT( oPosX,  oPosX,  oWaterObjUnkF4),
    SUM_FLOAT( oPosZ,  oPosZ,  oWaterObjUnkF8),
    SET_RANDOM_FLOAT(oWaterObjUnkFC,  0,  50),
    SUM_FLOAT( oPosY,  oPosY,  oWaterObjUnkFC),
    SET_INT(oAnimState, -1),
...
const BehaviorScript bhvSmallWaterWave398[] = {
    ADD_INT(oAnimState, 1),
    ADD_FLOAT(oPosY, 7),
    SET_RANDOM_FLOAT(oWaterObjUnkF4,  -2,  5),
    SET_RANDOM_FLOAT(oWaterObjUnkF8,  -2,  5),
    SUM_FLOAT( oPosX,  oPosX,  oWaterObjUnkF4),
    SUM_FLOAT( oPosZ,  oPosZ,  oWaterObjUnkF8),
    RETURN(),
};
...
const BehaviorScript bhvWaterAirBubble[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    SET_HITBOX_WITH_OFFSET( 400,  150,  -150),
    SET_INT(oIntangibleTimer, 0),
...
const BehaviorScript bhvCannon[] = {
    ...
    SPAWN_CHILD( MODEL_CANNON_BARREL,  bhvCannonBarrel),
...
const BehaviorScript bhvChuckya[] = {
    ...
    SET_HITBOX( 150,  100),
    SET_OBJ_PHYSICS( 30,  -400,  -50,  1000,  1000,  200,  0, 0),
    SPAWN_OBJ( MODEL_NONE,  bhvChuckyaAnchorMario),
...
const BehaviorScript bhvThreeCoinsSpawn[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_REPEAT(3),
        SPAWN_CHILD( MODEL_YELLOW_COIN,  bhvSingleCoinGetsSpawned),
    END_REPEAT(),
    DEACTIVATE(),
};
...
const BehaviorScript bhvUkikiCage[] = {
    ...
    SPAWN_CHILD( MODEL_STAR,  bhvUkikiCageStar),
    SPAWN_CHILD( MODEL_NONE,  bhvUkikiCageChild),
...
const BehaviorScript bhvBitFSSinkingCagePlatform[] = {
    ...
    SET_HOME(),
    SPAWN_CHILD( MODEL_BITFS_BLUE_POLE,  bhvDDDMovingPole),
    BEGIN_LOOP(),
...
const BehaviorScript bhvHeaveHo[] = {
    ...
    SPAWN_OBJ( MODEL_NONE,  bhvHeaveHoThrowMario),
    SET_INT(oInteractType, INTERACT_GRABBABLE),
...
const BehaviorScript bhvJumpingBox[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO  | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_OBJ_PHYSICS( 30,  -400,  -50,  1000,  1000,  600,  0, 0),
    BEGIN_LOOP(),
...
const BehaviorScript bhvBowser[] = {
    ...
    SPAWN_CHILD( MODEL_NONE,  bhvBowserBodyAnchor),
    SPAWN_CHILD( MODEL_BOWSER_BOMB_CHILD_OBJ,  bhvBowserFlameSpawn),
    SPAWN_OBJ( MODEL_NONE,  bhvBowserTailAnchor),
...
const BehaviorScript bhvFlameBouncing[] = {
    ...
    SET_OBJ_PHYSICS( 0,  -400,  -70,  0,  0,  200,  0, 0),
    BEGIN_LOOP(),
...
const BehaviorScript bhvLLLRotatingHexFlame[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_FLAME),
    SET_HITBOX_WITH_OFFSET( 50,  100,  50),
    SET_INT(oIntangibleTimer, 0),
    BILLBOARD(),
    BEGIN_LOOP(),
...
const BehaviorScript bhvBub[] = {
    ...
    ANIMATE(0),
    SET_HITBOX_WITH_OFFSET( 20,  10,  10),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_INT(oDamageOrCoinValue, 1),
    SET_HOME(),
    SET_INT(oIntangibleTimer, 0),
...
const BehaviorScript bhvSushiShark[] = {
    ...
    SPAWN_OBJ( MODEL_NONE,  bhvSushiSharkCollisionChild),
    SET_HITBOX_WITH_OFFSET( 100,  50,  50),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_INT(oDamageOrCoinValue, 3),
    SET_HOME(),
...
const BehaviorScript bhvMistParticleSpawner[] = {
    ...
    DISABLE_RENDERING(),
    SPAWN_CHILD( MODEL_MIST,  bhvWhitePuff1),
    SPAWN_CHILD( MODEL_SMOKE,  bhvWhitePuff2),
    DELAY(1),
    DEACTIVATE(),
};
...
const BehaviorScript bhvGhostHuntBoo[] = {
    ...
    SET_FLOAT(oGraphYOffset, 30),
    CALL_NATIVE(bhv_init_room),
    SPAWN_CHILD( MODEL_YELLOW_COIN,  bhvCoinInsideBoo),
    SET_OBJ_PHYSICS( 30,  0,  -50,  1000,  1000,  200,  0, 0),
    CALL_NATIVE(bhv_boo_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvSparkleParticleSpawner[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_FLOAT(oGraphYOffset, 25),
    SET_RANDOM_FLOAT(oMarioParticleFlags,  -50,  100),
    SUM_FLOAT( oPosX,  oPosX,  oMarioParticleFlags),
    SET_RANDOM_FLOAT(oMarioParticleFlags,  -50,  100),
    SUM_FLOAT( oPosZ,  oPosZ,  oMarioParticleFlags),
    SET_RANDOM_FLOAT(oMarioParticleFlags,  -50,  100),
    SUM_FLOAT( oPosY,  oPosY,  oMarioParticleFlags),
    SET_INT(oAnimState, -1),
    BEGIN_REPEAT(12),
        ADD_INT(oAnimState, 1),
    END_REPEAT(),
...
extern void bhv_net_player_loop(void);
const BehaviorScript bhvNetPlayer[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_net_player_loop),
    END_LOOP(),
};
#endif
...
const BehaviorScript bhvObjectBubble[] = {
    ...
    SET_RANDOM_FLOAT(oVelY,  3,  6),
    SET_INT_RAND_RSHIFT(oMoveAngleYaw,  0,  0),
    DELAY(1),
    BEGIN_LOOP(),
...
const BehaviorScript bhvBobombExplosionBubble[] = {
    ...
    ADD_RANDOM_FLOAT(oPosX,  -50,  100),
    ADD_RANDOM_FLOAT(oPosY,  -50,  100),
    ADD_RANDOM_FLOAT(oPosZ,  -50,  100),
...
const BehaviorScript bhvBobombExplosionBubble3600[] = {
    ADD_RANDOM_FLOAT(oPosX,  -2,  4),
    ADD_RANDOM_FLOAT(oPosZ,  -2,  4),
    RETURN(),
};
...
const BehaviorScript bhvJetStreamWaterRing[] = {
    ...
    SET_HITBOX_WITH_OFFSET( 75,  20,  20),
    SET_INTERACT_TYPE(INTERACT_WATER_RING),
    SET_INT(oDamageOrCoinValue, 2),
    SET_INT(oIntangibleTimer, 0),
...
const BehaviorScript bhvKoopaRaceEndpoint[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    DROP_TO_FLOOR(),
    SPAWN_CHILD_WITH_PARAM( 0,  MODEL_KOOPA_FLAG,  bhvKoopaFlag),
    BEGIN_LOOP(),
...
const BehaviorScript bhvChainChomp[] = {
    ...
    SCALE( 0,  200),
    SPAWN_CHILD_WITH_PARAM( 0,  MODEL_WOODEN_POST,  bhvWoodenPost),
    BEGIN_LOOP(),
...
const BehaviorScript bhvWigglerBody[] = {
    ...
    SET_OBJ_PHYSICS( 0,  -400,  0,  1000,  1000,  200,  0, 0),
    SCALE( 0,  400),
    BEGIN_LOOP(),
...
const BehaviorScript bhvSpiny[] = {
    ...
    ANIMATE(0),
    SET_OBJ_PHYSICS( 40,  -400,  -50,  1000,  1000,  200,  0, 0),
    BEGIN_LOOP(),
...
const BehaviorScript bhvPlatformOnTrack[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_OBJ_PHYSICS( 50,  -100,  -50,  100,  1000,  200,  0, 0),
    CALL_NATIVE(bhv_init_room),
...
const BehaviorScript bhvWaterBomb[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_OBJ_PHYSICS( 120,  -400,  0,  1000,  1000,  200,  0, 0),
    BEGIN_LOOP(),
...
const BehaviorScript bhvMrBlizzardSnowball[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BILLBOARD(),
    SET_OBJ_PHYSICS( 30,  -300,  -50,  1000,  1000,  200,  0, 0),
    SCALE( 0,  200),
...
const BehaviorScript bhvFlyguyFlame[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    SET_OBJ_PHYSICS( 0,  200,  0,  1000,  1000,  200,  0, 0),
    BEGIN_LOOP(),
...
const BehaviorScript bhvSnufitBalls[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BILLBOARD(),
    SET_OBJ_PHYSICS( 10,  0,  -50,  1000,  1000,  200,  0, 0),
    CALL_NATIVE(bhv_init_room),
    SET_FLOAT(oGraphYOffset, 10),
    SCALE( 0,  10),
    BEGIN_LOOP(),
...
const BehaviorScript bhvEyerokHand[] = {
    ...
    ANIMATE(6),
    SET_OBJ_PHYSICS( 150,  0,  0,  0,  1000,  200,  0, 0),
    SET_HOME(),
...
const BehaviorScript bhvRacingPenguin[] = {
    ...
    LOAD_ANIMATIONS(oAnimations, penguin_seg5_anims_05008B74),
    ANIMATE(3),
    SET_OBJ_PHYSICS( 300,  -800,  -5,  0,  0,  0,  0, 0),
    SCALE( 0,  400),
