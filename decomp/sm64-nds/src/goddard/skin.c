...
void reset_net(struct ObjNet *net) {
    ...
    gd_add_vec3f_to_mat4f_offset(&net->matE8, &net->worldPos);
...
void collision_something_801926A4(struct ObjNet *net) {
    if (gGdCounter.ctr1 != 0) {
        ...
        D_801B9E28.x *= 1.0 / gGdCounter.ctr1;
        D_801B9E28.y *= 1.0 / gGdCounter.ctr1;
        D_801B9E28.z *= 1.0 / gGdCounter.ctr1;
        D_801B9E18.x *= 1.0 / gGdCounter.ctr1;
        D_801B9E18.y *= 1.0 / gGdCounter.ctr1;
        D_801B9E18.z *= 1.0 / gGdCounter.ctr1;
