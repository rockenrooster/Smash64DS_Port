...
void render_hud_mario_lives(void) {
    ...
    print_text(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(38), HUD_TOP_Y, "*");
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(54), HUD_TOP_Y, "%d", gHudDisplay.lives);
}

void render_hud_coins(void) {
    print_text(168, HUD_TOP_Y, "+");
    print_text(184, HUD_TOP_Y, "*");
...
void render_hud_stars(void) {
    ...
    if (showX == 1) {
        print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(HUD_STARS_X) + 16, HUD_TOP_Y, "*");
    }
