            ...
            GEO_OPEN_NODE(),
                ...
                GEO_OPEN_NODE(),
                    ...
                    GEO_OPEN_NODE(),
                        ...
                        GEO_BRANCH(1, castle_geo_001578),
                        GEO_BRANCH(1, castle_geo_0015B8),
                        GEO_BRANCH(1, castle_geo_0015F8),
                        GEO_BRANCH(1, castle_geo_001628),
                        GEO_BRANCH(1, castle_geo_001668),
                        GEO_BRANCH(1, castle_geo_001690),
                        GEO_BRANCH(1, castle_geo_0016D8),
                        GEO_BRANCH(1, castle_geo_001740),
                        GEO_BRANCH(1, castle_geo_001798),
                        GEO_BRANCH(1, castle_geo_001800),
                    GEO_CLOSE_NODE(),
                    GEO_RENDER_OBJ(),
