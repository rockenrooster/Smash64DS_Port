...
const Collision thi_seg7_area_2_collision[] = {
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(3),
    SPECIAL_OBJECT_WITH_YAW( special_null_start,    -2211,  -890,  2212,  106),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_03,    -40,  -767, -4494,    0),
    SPECIAL_OBJECT( special_bubble_tree,    1444,  -153,   676),
