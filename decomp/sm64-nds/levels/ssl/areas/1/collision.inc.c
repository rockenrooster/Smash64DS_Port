...
const Collision ssl_seg7_area_1_collision[] = {
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(7),
    SPECIAL_OBJECT_WITH_YAW( special_null_start,      653, 38,  6566,  64),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_03,   5760,  0,  5751,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_03,  -3583,  0,  2935,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_03,   -511,  0,  2935,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_03,   1024,  0,  3822,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_03,   3072,  0,   375,   0),
