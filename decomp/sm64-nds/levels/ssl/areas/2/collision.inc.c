...
const Collision ssl_seg7_area_2_collision[] = {
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(4),
    SPECIAL_OBJECT_WITH_YAW( special_null_start,        0,     0,  6451,  128),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_04,   1741,  -101,  1843,    0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_04,      0,  -101,   528,    0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_04,  -1740,  -101,  1843,    0),
    COL_END(),
};
