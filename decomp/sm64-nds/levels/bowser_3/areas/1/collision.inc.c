...
const Collision bowser_3_seg7_collision_level[] = {
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(7),
    SPECIAL_OBJECT_WITH_YAW( special_null_start,        0,   307,     0,   128),
    SPECIAL_OBJECT( special_bowser,           13,   307, -1024),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_03,  -3362,  -204,  1121,     0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_03,      0,  -204,  3584,     0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_03,   3362,  -204,  1126,     0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_03,   2123,  -204, -2912,     0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_03,  -2122,  -204, -2912,     0),
    COL_END(),
};
