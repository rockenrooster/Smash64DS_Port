...
const LevelScript level_main_scripts_entry[] = {
    LOAD_MIO0( 0x04, _group0_mio0SegmentRomStart, _group0_mio0SegmentRomEnd),
    LOAD_MIO0( 0x03, _common1_mio0SegmentRomStart, _common1_mio0SegmentRomEnd),
    LOAD_RAW ( 0x17, _group0_geoSegmentRomStart, _group0_geoSegmentRomEnd),
    LOAD_RAW ( 0x16, _common1_geoSegmentRomStart, _common1_geoSegmentRomEnd),
    ...
    LOOP_BEGIN(),
        EXECUTE( 0x14, _menuSegmentRomStart, _menuSegmentRomEnd, level_main_menu_entry_2),
        JUMP_LINK(script_exec_level_table),
        SLEEP( 1),
    LOOP_UNTIL( OP_LT,  0),
    JUMP_IF( OP_EQ,  -1, script_L2),
    JUMP_IF( OP_EQ,  -2, goto_mario_head_regular),
    JUMP_IF( OP_EQ,  -3, goto_mario_head_dizzy),
    JUMP_IF( OP_EQ,  -8, script_L1),
    JUMP_IF( OP_EQ,  -9, script_L5),
};
...
static const LevelScript script_L2[] = {
    EXIT_AND_EXECUTE( 0x0E, _endingSegmentRomStart, _endingSegmentRomEnd, level_ending_entry),
};
...
static const LevelScript goto_mario_head_dizzy[] = {
    EXIT_AND_EXECUTE( 0x14, _introSegmentRomStart, _introSegmentRomEnd, level_intro_mario_head_dizzy),
};
...
static const LevelScript script_exec_level_table[] = {
    GET_OR_SET( OP_GET,  VAR_CURR_LEVEL_NUM),
