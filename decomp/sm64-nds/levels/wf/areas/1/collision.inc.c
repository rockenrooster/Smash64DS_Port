...
const Collision wf_seg7_collision_070102D8[] = {
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(6),
    SPECIAL_OBJECT_WITH_YAW( special_null_start,     2560,  256, 5120,  64),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_0E,   3584,  154, 4864,  0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_0F,   4608,  256, 1792,  0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_11,  -2499, 1792, -261,  0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_12,  -2661,  384,  640,  0),
