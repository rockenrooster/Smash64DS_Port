...
const Collision sl_seg7_area_1_collision[] = {
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(10),
    SPECIAL_OBJECT_WITH_YAW( special_null_start,   5541,  1024,   443,  192),
    SPECIAL_OBJECT( special_snow_tree,    5395,  1054, -5443),
    SPECIAL_OBJECT( special_snow_tree,       0,  4864,     0),
    SPECIAL_OBJECT( special_snow_tree,    5666,  1024, -3341),
    SPECIAL_OBJECT( special_snow_tree,    1919,  1024, -4759),
    SPECIAL_OBJECT( special_snow_tree,    3645,  1024, -5889),
    SPECIAL_OBJECT( special_snow_tree,    1658,  1536, -3605),
    SPECIAL_OBJECT( special_snow_tree,   -3769,  1024, -1197),
    SPECIAL_OBJECT( special_snow_tree,   -2745,  1024,  -582),
    SPECIAL_OBJECT( special_snow_tree,    1766,  2816,  -942),
