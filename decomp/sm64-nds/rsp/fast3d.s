...
operationJumpTable:
  jumpTableEntry dispatch_dma
spNoopEntry:
  jumpTableEntry SP_NOOP
  jumpTableEntry dispatch_imm
  jumpTableEntry dispatch_rdp

dmaJumpTable:
  jumpTableEntry SP_NOOP
  jumpTableEntry dma_MTX
  jumpTableEntry SP_NOOP
  jumpTableEntry dma_MOVEMEM
  jumpTableEntry dma_VTX
  jumpTableEntry SP_NOOP
  jumpTableEntry dma_DL
  jumpTableEntry SP_NOOP
  jumpTableEntry SP_NOOP
  jumpTableEntry SP_NOOP
...
.endif
immediateJumpTable:
  jumpTableEntry imm_RDPHALF_CONT
  jumpTableEntry imm_RDPHALF_2
  jumpTableEntry imm_RDPHALF_1
  jumpTableEntry SP_NOOP
  jumpTableEntry imm_CLEARGEOMETRYMODE
  jumpTableEntry imm_SETGEOMETRYMODE
  jumpTableEntry imm_ENDDL
  jumpTableEntry imm_SETOTHERMODE_L
  jumpTableEntry imm_SETOTHERMODE_H
  jumpTableEntry imm_TEXTURE
  jumpTableEntry imm_MOVEWORD
  jumpTableEntry imm_POPMTX
  jumpTableEntry imm_CULLDL
  jumpTableEntry imm_TRI1
...
.definelabel lightInfo5, lightInfo4 + 0x20
.definelabel lightInfo6, lightInfo5 + 0x20
.definelabel lightInfo7, lightInfo6 + 0x20
...
f3d_04001998:
    ...
    bne   $12, $zero, SP_NOOP
     or    $11, $11, $9
    andi  $11, $11, 0x4343
    bne   $11, $zero, f3d_04001768
f3d_040019c4:
     llv   $v13[0], 0x18($1)
    llv   $v14[0], 0x18($2)
    llv   $v15[0], 0x18($3)
    lw    $13, 0x04($29)
    addi  $8, $zero, setupTemp
    lsv   $v21[0], 0x02($29)
    lsv   $v5[0], 0x06($1)
    vsub  $v10, $v14, $v13
    lsv   $v6[0], 0x0e($1)
...
@@f3d_04001790:
    ...
    beq   $8, $zero, @f3d_040015e4
     lw    $16, 0x04($7)
    andi  $8, $3, G_TEXTURE_GEN_LINEAR_H
    lpv   $v7[0], 0x90($29)
    ldv   $v6[0], 0xa0($zero)
    vmadn $v20, $v7, $v20[0h]
