"""Slice 5 gate tables (from slice 4's gates4.py): percentiles, bands, per-range means, VBlank shares.

Usage: gates5.py CONTROL_ARM CANDIDATE_ARM [more arms]
Arms are artifact names (ARM-rows.csv + ARM.json in the slice 5 folder; prefix
s4: / s3: for the slice 4 / slice 3 folders).
...
ART = r'D:\Stuff\DevFolder\Smash64DS_Port\artifacts\performance\2026-09-23_p2-2p8-phase1-slice5'
ART4 = ART.replace('slice5', 'slice4')
ART3 = ART.replace('slice5', 'slice3')
