...
# P2-2p8 Phase 1 slice 2b sampler wrapper: runner slot 9 / GDB 3423 only.
# The words are poked at the first frame-complete marker (whole u32 words).
$ErrorActionPreference = 'Continue'
$root = 'D:\Stuff\DevFolder\Smash64DS_Port'
$art = Join-Path $root 'artifacts\performance\2026-09-23_p2-2p8-phase1-slice2b'
...
$sets = @("gNdsFtrLeanRoute=$Route", "gNdsFtrLeanAdmit=$Admit")
