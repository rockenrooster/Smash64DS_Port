...
**A second apparatus lane, found 2026-08-13: the debug/HUD TEXT path, 3,984
tk/frame.** `ndsPlatformPrintDebugLine` (`nds_platform.c:2059`, 461 calls a
match) → `vsniprintf`/`iprintf` → `_vfiprintf_r` → `consolePrintChar`, plus the
