"""Slice 6 gate tables (from slice 5's gates5.py): percentiles, bands, per-range means, VBlank shares.

Usage: gates5.py CONTROL_ARM CANDIDATE_ARM [more arms]
Arms are artifact names (ARM-rows.csv + ARM.json in the slice 6 folder; prefix
s5: / s4: / s3: for the slice 5 / 4 / 3 folders).
...
ART = r'D:\Stuff\DevFolder\Smash64DS_Port\artifacts\performance\2026-09-23_p2-2p8-phase1-slice6'
ART5 = ART.replace('slice6', 'slice5')
ART4 = ART.replace('slice6', 'slice4')
ART3 = ART.replace('slice6', 'slice3')
