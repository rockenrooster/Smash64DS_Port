...
Arms are artifact names (ARM-rows.csv + ARM.json in the slice 3 folder; prefix 2b: for the slice 2b folder).
...
ART = r'D:\Stuff\DevFolder\Smash64DS_Port\artifacts\performance\2026-09-23_p2-2p8-phase1-slice3'
ART2C = ART.replace('slice3', 'slice2c')
ART2B = ART.replace('slice3', 'slice2b')
