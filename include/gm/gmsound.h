...
typedef enum gmMusicID
{
    ...
    nSYAudioBGMStar = 46,
    nSYAudioBGMBossStage = 23,
    nSYAudioBGMBossEntry = 24,
    nSYAudioBGMLast = 25,
    nSYAudioBGM1PBonusStage = 26,
    nSYAudioBGM1PStageClear = 27,
    nSYAudioBGM1PBonusStageClear = 28,
    nSYAudioBGM1PGameClear = 29,
    nSYAudioBGM1PBonusStageFailure = 30,
    nSYAudioBGM1PGameEndChoice = 31,
    nSYAudioBGM1PGameOver = 32,
    nSYAudioBGMOpening = 33,
    nSYAudioBGMExplain = 34,
    nSYAudioBGM1PIntro = 35,
    nSYAudioBGMZako = 36,
    nSYAudioBGMMetal = 37,
    nSYAudioBGMEnding = 38,
    nSYAudioBGMStaffroll = 39,
    nSYAudioBGMMessage = 40,
    nSYAudioBGM1PChallenger = 41,
    nSYAudioBGMTrainingMode = 42,
    nSYAudioBGMData = 43
} gmMusicID;
...
typedef enum gmFGMID
{
    ...
    nSYAudioFGMUnkShoot1 = 3,
    nSYAudioFGMUnkDial1 = 4,
    nSYAudioFGMChargeShotAll = 5,
    nSYAudioFGMFoxBlaster = 7,
    nSYAudioFGMDoorClose = 20,
    nSYAudioFGMTrainingSel = 21,
    nSYAudioFGMHammerSwing = 50,
    nSYAudioFGMStarRodSwing4 = 63,
    nSYAudioFGMStarRodSwing1 = 65,
    nSYAudioFGMSwordSwing4 = 67,
    nSYAudioFGMSwordSwing1 = 69,
    nSYAudioFGMTaruBombHit = 70,
    nSYAudioFGMTaruBombMap = 71,
    nSYAudioFGMUnkGrind2 = 83,
    nSYAudioFGMFoxFoot = 107,
    nSYAudioFGMMMarioFoot = 122,
    nSYAudioFGMOpeningSectorAmbient = 148,
    nSYAudioFGMOpeningNewcomersClash = 149,
    nSYAudioFGMPublicPrologue = 150,
    nSYAudioFGMOpeningBatM = 152,
    nSYAudioFGMUnkMechanical1 = 156,
    nSYAudioFGMTitlePressStart = 157,
    nSYAudioFGM1PGameContinue = 160,
    nSYAudioFGMTrainingSel2 = 162,
    nSYAudioFGMScoreDisplayBonus = 168,
    ...
    nSYAudioFGMMarioAppealGrow = 212,
    nSYAudioFGMMarioAppealShrink = 213,
    nSYAudioFGMBladeSwing1 = 260,
...
typedef enum gmVoiceID
{
    ...
    nSYAudioVoiceLinkSmash2 = 402,
    nSYAudioVoiceLinkSmash3 = 403,
    nSYAudioVoiceLinkSpecialHi = 404,
    nSYAudioVoiceLinkDeadUp = 405,
    nSYAudioVoiceLinkDamage = 407,
    nSYAudioVoiceLinkJump = 408,
    nSYAudioVoiceLinkJumpAerial = 409,
    nSYAudioVoiceLinkOttotto = 412,
    nSYAudioVoiceLinkDead = 413,
    nSYAudioVoiceLinkGrunt2 = 415,
    nSYAudioVoiceFoxHeavyGet = 367,
    nSYAudioVoiceFoxFuraFura = 376,
    nSYAudioVoiceBossDead = 492,
    nSYAudioVoiceBossAppear = 493,
    nSYAudioVoiceAnnounceComplete = 459,
    nSYAudioVoiceAnnounceMMario = 462,
    nSYAudioVoiceAnnounceTitleWait = 463,
    nSYAudioVoiceAnnounceNewRecord = 464,
    nSYAudioVoiceAnnounceCongra = 465,
    nSYAudioVoiceAnnounceIncredible = 466,
    nSYAudioVoiceAnnounceBoardThePlatforms = 476,
    nSYAudioVoiceAnnounceBonusStage = 477,
    nSYAudioVoiceAnnounceBreakTheTargets = 478,
    nSYAudioVoiceAnnounceSelectPlayer = 479,
    nSYAudioVoiceAnnounceContinue = 481,
    nSYAudioVoiceAnnounceZako = 482,
    nSYAudioVoiceAnnounceGameOver = 487,
    nSYAudioVoiceAnnounceGDonkey = 489,
    nSYAudioVoiceAnnounceHowToPlay = 494,
    nSYAudioVoiceAnnounceRaceToTheFinish = 495,
    nSYAudioVoiceAnnounceMarioBros = 500,
    nSYAudioVoiceAnnounceKirbyTeam = 529,
    nSYAudioVoiceAnnounceTrainingMode = 530,
    nSYAudioVoiceAnnounceYoshiTeam = 531,
    nSYAudioVoiceAnnounceVersus = 532,
    nSYAudioVoicePublicClapS = 629,
