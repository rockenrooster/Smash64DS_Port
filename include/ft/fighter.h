...
/* decomp ft/ftdef.h:56-57: the Characters (DATA) screen demo statuses. */
...
enum {
    ...
    /* BattleShip ftluigi.h:20-46.  Luigi owns a nine-entry special motion /
     * status window at the same common-table boundary as Mario; the callbacks
     * are mostly Mario's, but the indices are Luigi's and must not alias the
     * Mario enum just because the state-machine functions are shared. */
    ...
    /* BattleShip ftdonkey.h:37-73.  DK extends its special-motion window with
     * the cargo carry ladder.  Keep every ordinal source-exact: ftMainSetStatus
     * indexes dFTDonkeyMotionDescs with these values, so treating cargo as a
     * generic grab modifier would select the wrong animation/state contract. */
    ...
    /* BattleShip ftness.h ftNessMotion, admit_fighter.py. */
    ...
    /* BattleShip ftkirby.h ftKirbyMotion, admit_fighter.py. */
    ...
    /* BattleShip ftdonkey.h:75-115.  The nine cargo statuses are fighter-owned
     * source states, followed by the forward throw and heavy-item throw window. */
    ...
    nFTDonkeyStatusHeavyThrowStart,
    ...
    /* BattleShip ftness.h ftNessStatus, admit_fighter.py. */
    ...
    nFTNessStatusSpecialLwScopeStart,
    ...
    nFTNessStatusSpecialLwScopeEnd = nFTNessStatusSpecialAirLwEnd,
    /* BattleShip ftpurin.h ftPurinStatus, admit_fighter.py. */
    ...
    /* BattleShip ftkirby.h ftKirbyStatus, admit_fighter.py. */
...
#define FTCOMMON_JUMPAERIAL_TURN_ROTATE_STEP \
    (-(F_CLC_DTOR32(180.0F) / FTCOMMON_JUMPAERIAL_TURN_FRAMES))
...
#define FTCOMMON_ATTACKS3_5ANGLE_HI_MIN F_CLC_DTOR32(30.0F)
#define FTCOMMON_ATTACKS3_5ANGLE_HIS_MIN F_CLC_DTOR32(10.0F)
#define FTCOMMON_ATTACKS3_5ANGLE_LW_MIN F_CLC_DTOR32(-30.0F)
#define FTCOMMON_ATTACKS3_5ANGLE_LWS_MIN F_CLC_DTOR32(-10.0F)
#define FTCOMMON_ATTACKS3_3ANGLE_HI_MIN F_CLC_DTOR32(17.0F)
#define FTCOMMON_ATTACKS3_3ANGLE_LW_MIN F_CLC_DTOR32(-17.0F)
...
#define FTCOMMON_ATTACKS4_5ANGLE_HI_MIN F_CLC_DTOR32(21.0F)
#define FTCOMMON_ATTACKS4_5ANGLE_HIS_MIN F_CLC_DTOR32(7.0F)
#define FTCOMMON_ATTACKS4_5ANGLE_LW_MIN F_CLC_DTOR32(-21.0F)
#define FTCOMMON_ATTACKS4_5ANGLE_LWS_MIN F_CLC_DTOR32(-7.0F)
#define FTCOMMON_ATTACKS4_3ANGLE_HI_MIN F_CLC_DTOR32(17.0F)
#define FTCOMMON_ATTACKS4_3ANGLE_LW_MIN F_CLC_DTOR32(-17.0F)
...
enum {
    ...
    nGMColAnimFighterCommonSpecialNCharge = 6,
    ...
    /* BattleShip gmdef.h: Kirby's five Stone scripts sit between Captain's
     * SpecialN (50) and Pikachu's block; ftkirby.h's STONE_COLANIM_ID_HIGH/
     * MID/LOW are 0x33..0x35. */
    nGMColAnimFighterKirbySpeciaLwHigh = 51,
    nGMColAnimFighterKirbySpeciaLwMid = 52,
    nGMColAnimFighterKirbySpeciaLwLow = 53,
    nGMColAnimFighterKirbySpecialLwStart = 54,
    nGMColAnimFighterKirbySpecialLwEnd = 55,
    ...
    /* Ness's five follow Captain's SpecialHi (62); ftness.h's
     * PSYCHICMAGNET_COLANIM_ID is 0x3F. */
    nGMColAnimFighterNessSpecialLwHold = 63,
    nGMColAnimFighterNessSpecialLwHit = 64,
    nGMColAnimFighterNessSpecialHiHold = 65,
