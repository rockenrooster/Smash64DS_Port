#ifndef SSB64_NDS_SYS_OBJMAN_H
#define SSB64_NDS_SYS_OBJMAN_H

/* Object manager public prototypes.
 *
 * Mirrors the original BattleShip sys/objman.h verbatim. The object manager
 * translation unit (sys/objman.c) is imported directly, so this header simply
 * exposes the real public contract: gcSetupObjman, the gcMake and gcAdd
 * helpers, the free-list allocators, and the run/draw entry points. No
 * behavior is reimplemented here. */
#include <sys/debug.h>
