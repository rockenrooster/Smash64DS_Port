#ifndef SSB64_NDS_SYS_OBJHELPER_H
#define SSB64_NDS_SYS_OBJHELPER_H

/* Object helper prototypes.
 *
 * Mirrors the original BattleShip sys/objhelper.h verbatim. The helper
 * translation unit (sys/objhelper.c) is imported directly, so this header
 * exposes the real public contract: the gcMake*GObj convenience constructors,
 * gcSleepCurrentGObjThread, and the GObj lookup/walk helpers. */
